...
However, as discussed in Section \@ref(dsmConcerns), diagnoses are fictive categories that have poor [diagnostic validity](#sec-diagnosticValidity).\index{psychopathology!structure of}\index{Research Domain Criteria}\index{Diagnostic and Statistical Manual of Mental Disorders}\index{validity!diagnostic}
...
As described in Section \@ref(overfitting), [over-fitting](#sec-overfitting) involves explaining noise variance, a finding which would not generalize to a new sample.\index{biological assessment}\index{over-fitting}\index{rich data}
