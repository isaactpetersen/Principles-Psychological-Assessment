...
The [confirmatory factor analysis (CFA) models](#cfa) were fit in the `lavaan` package [@R-lavaan]. The examples were adapted from the `lavaan` documentation: http://lavaan.ugent.be/tutorial/cfa.html
