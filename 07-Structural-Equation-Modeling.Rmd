...
sampleSizes2_ex <- 150
repetitionsPerSampleSize2_ex <- 100
```
...
You plan to assess stress with three methods (self-report, friend report, cortisol), harsh parenting with four methods (parents' self-report, spousal report, child report, observation), and children's antisocial behavior with four methods (parent report, teacher report, child report, observation).
    ...
    d. Re-run the power analysis with normally distributed values (skewness $= 0$, kurtosis $= 0$), using 100 repetitions with a sample size of 150.
    Did power to detect the hypothesized effects increase or decrease?
    What does this indicate?
    e. Re-run the power analysis using multiple imputation instead of FIML (and normally distributed values); use 100 repetitions with a sample size of 150 and use five imputations.
    Did power to detect the hypothesized effects increase or decrease?
    What does this indicate?
