...
For instance, you could use two items to indicate where the person is on the construct: low, middle, or high (see Figure \@ref(fig:efficientAssessment)).\index{item response theory}\index{brief assessment}
