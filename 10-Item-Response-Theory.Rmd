...
In this example, we estimate a 2PL multidimensional IRT model by estimating two factors.\index{item response theory!two-parameter model}\index{item response theory!multidimensional model}
