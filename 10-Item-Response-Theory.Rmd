...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figure \@ref(fig:onePLicc).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figure \@ref(fig:onePLiif).\index{item response theory!information}\index{item response theory!item information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the expected score on the item as a function of a person's level on the latent construct (theta; $\theta$) are in Figure \@ref(fig:gradedResponseModelICC).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figure \@ref(fig:gradedResponseModelIIF).\index{item response theory!information}\index{item response theory!item information curve}
