...
A multi-trait multi-method matrix can be organized by method and then by construct or vice versa. A MTMM organized by method then by construct is depicted in Figure \@ref(fig:mtmmMethodConstruct).

```{r mtmmMethodConstruct, out.width = "100%", fig.align = "center", fig.cap = "Multi-trait multi-method matrix organized by method then by construct.", echo = FALSE}
...
```{r mtmmConstructMethod, out.width = "100%", fig.align = "center", fig.cap = "Multi-trait multi-method matrix organized by construct then by method.", echo = FALSE}
...
disattenuationSEM <- '
  ...
  # Factor correlation
  predictorLatent ~ criterionLatent
