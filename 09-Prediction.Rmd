...
```{r}
pBgivenNotA <- function(pBgivenA, pB, pA){
  value <- (pB - (pBgivenA * pA)) / (1 - pA)
  
  value
}

pBgivenNotA(pBgivenA = .95, pB = .01, pA = .003)
```
...
pB(pBgivenA = .95, pA = pAgivenB(pBgivenA = .95, pA = .003, pB = .01), pBgivenNotA = pBgivenNotA(pBgivenA = .95, pB = .01, pA = .003))
```
...
pAgivenB(pBgivenA = .95,
         ...
         pB = pB(pBgivenA = .95,
                 pA = pAgivenB(pBgivenA = .95, pA = .003, pB = .01),
                 pBgivenNotA = pBgivenNotA(pBgivenA = .95, pB = .01, pA = .003)))
```
...
pAgivenBalternative(pBgivenA = .95, pA = .003, pBgivenNotA = pBgivenNotA(pBgivenA = .95, pB = .01, pA = .003))
```
...
pAgivenBalternative(pBgivenA = .95, pA = .285, pBgivenNotA = pBgivenNotA(pBgivenA = .95, pB = .01, pA = .003))
```
