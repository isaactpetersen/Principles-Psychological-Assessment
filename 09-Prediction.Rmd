...
The `petersenlab` package [@R-petersenlab] contains an R function that estimates the probability of one event, $A$, given another event, $B$.
...
The `petersenlab` package [@R-petersenlab] contains an R function that estimates the probability of one event, $B$, given that another event, $A$, did not occur.
...
The `petersenlab` package [@R-petersenlab] contains an R function that estimates the marginal probability of one event, $B$.
...
The `petersenlab` package [@R-petersenlab] contains an R function that estimates the prediction accuracy across cutoffs.
...
The `petersenlab` package [@R-petersenlab] contains an R function that estimates the prediction accuracy at a given cutoff.
