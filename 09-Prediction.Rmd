...
$R^2$ is commonly estimated in multiple regression, in which multiple predictors are allowed to predict one outcome. $R^2$ in multiple regression is depicted conceptually in Figure \@ref(fig:multipleRegressionRSquared).

```{r multipleRegressionRSquared, out.width = "100%", fig.align = "center", fig.cap = "Conceptual depiction of proportion of variance explained ($R^2$) in an outcome variable (Y) by multiple predictors (X1 and X2) in multiple regression.", echo = FALSE}
...
```{r multipleRegressionMulticollinearity, out.width = "100%", fig.align = "center", fig.cap = "Conceptual depiction of multicollinearity in multiple regression.", echo = FALSE}
