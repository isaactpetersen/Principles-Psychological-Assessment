...
pAgivenB(pBgivenA = .95, pA = .003, pBgivenNotA = pBgivenNotA(pBgivenA = .95, pA = .003, pB = .01))
```
...
pAgivenB(pBgivenA = .95, pA = .285, pBgivenNotA = pBgivenNotA(pBgivenA = .95, pA = .003, pB = .01))
```
...
```{r}
accuracyAtCutoff(predicted = mydataSDT$testScore, actual = mydataSDT$disorder, cutoff = cutoff) %>% t
```
...
```{r}
accuracyAtEachCutoff(predicted = mydataSDT$testScore, actual = mydataSDT$disorder,
