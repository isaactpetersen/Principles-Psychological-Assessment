...
```{r}
accuracyOverall(predicted = mydataSDT$testScore, actual = mydataSDT$disorder)
```
...
```{r}
accuracyAtCutoff(predicted = mydataSDT$testScore, actual = mydataSDT$disorder, cutoff = cutoff)
```
