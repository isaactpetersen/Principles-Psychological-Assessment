...
```{r bayesTheorem2x2, out.width = "100%", fig.align = "center", fig.cap = "[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix.", echo = FALSE}
...
```{r twoByTwoMatrix1, out.width = "100%", fig.align = "center", fig.cap = "[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix.", echo = FALSE}
...
```{r twoByTwoMatrix2, out.width = "100%", fig.align = "center", fig.cap = "[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums.", echo = FALSE}
...
```{r twoByTwoMatrix3, out.width = "100%", fig.align = "center", fig.cap = "[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums And Marginal Probabilities.", echo = FALSE}
...
```{r twoByTwoMatrix5, out.width = "100%", fig.align = "center", fig.cap = "[Cnfusion Matrix](#confusionMatrix): 2x2 Prediction Matrix.", echo = FALSE}
...
The index is called the **a**rea **u**nder the [**R**OC](#roc) (AUC).
...
The predictor (`testScore`) explains $`r apa(rSquaredValue * 100, 2)`$% of the variance $(R^2 = `r apa(rSquaredValue, 2, leading = FALSE)`)$ in the outcome (`disorder` status).
...
(ref:calibrationWeatherChannelCaption) Calibration Plot Of Same-Day Probability Of Precipitation (PoP) Forecasts From The Weather Channel. Figure reprinted from @Bickel2008, Figure 2, p. 4872. Bickel, J. E., & Kim, S. D. (2008). Verification of the weather channel probability of precipitation forecasts. *Monthly Weather Review*, *136*(12), 4867–4881. doi: [https://doi.org/10.1175/2008MWR2547.1](https://doi.org/10.1175/2008MWR2547.1) Copyright (c) American Meteorological Society. Used with permission.
