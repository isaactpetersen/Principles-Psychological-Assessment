...
```{r calibrationNWS, out.width = "100%", fig.align = "center", fig.cap = "calibrationNWSCaption", echo = FALSE}
...
This means that there are different prediction equation possibilities that are equally good (see Equations in \@ref(eq:multicollinearity):
