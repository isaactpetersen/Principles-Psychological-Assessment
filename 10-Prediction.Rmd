...
Bayes' theorem is in Equation \@ref(eq:bayes1):\index{Bayes' theorem}\index{probability!inverse conditional}
...
As seen in the rearranged formula in Equation \@ref(eq:bayes3), the inverse [conditional probabilities](#conditionalProbability) ($P(C | R)$ and $P(R | C)$) are not equal unless the [base rates](#baseRate) of $C$ and $R$ are the same.\index{Bayes' theorem}\index{probability!conditional}\index{probability!marginal}\index{base rate}\index{probability!inverse conditional}
...
People commonly make cognitive pseudo-prediction errors, such as the [confusion of inverse probabilities](#inverseFallacy).\index{pseudo-prediction}\index{confusion of the inverse}\index{probability!inverse conditional}
