...
For example, here is an example of estimating predictive $R^2$ 10-fold cross-validation using the `caret` package [@R-caret].\index{predictive $R^2$}\index{cross-validation}
