...
```{r twoByTwoMatrix4, out.width = "100%", fig.align = "center", fig.cap = "Chance Expectancies in 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio.", echo = FALSE}
...
One can also generate the probability nomogram from the base rate, positive likelihood ratio, and negative likelihood ratio:\index{petersenlab package}\index{probability!nomogram}
