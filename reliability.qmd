...
library("psychmeta")
library("irr")
library("irrCAC") #to install: install.packages("https://cran.r-project.org/src/contrib/Archive/irrCAC/irrCAC_1.0.tar.gz")
library("irrICC")
library("irrNA")
library("gtheory")
library("performance")
