...
G-theory is described in detail in Chapter \@ref(gTheory) on generalizability theory and is also discussed in the chapters on validity (Chapter \@ref(validity), @sec-gTheoryValidity)), and structural equation modeling (Chapter \@ref(sem), @sec-generalizability-SEM)).\index{generalizability theory}
...
This is discussed in greater detail in @sec-differenceScore-reliability) and in Chapter \@ref(cognition) (@sec-differenceScores)) on cognitive assessment.\index{reliability!ways to increase}\index{difference score}
