...
![](images/Reliability_1.png){width=100% fig-alt="Reliability of a Measure Across Two Time Points, as Depicted in a Path Diagram."}
...
![](images/Reliability_2.png){width=100% fig-alt="Reliability of a Measure Across Two Time Points, as Depicted in a Path Diagram; Includes the Index of Reliability."}
...
![](images/Reliability_3.png){width=100% fig-alt="Reliability of a Measure of a Stable Construct Across Two Time Points, as Depicted in a Path Diagram."}
...
As with [difference scores](#differenceScore-reliability), product terms tend to have lower reliability than the individual indices that compose them [@Aguinis2017; @Busemeyer1983; @Jaccard1995; @McClelland1993].\index{reliability!product term}\index{moderation}\index{moderation@\igobble|seealso{interaction}}
