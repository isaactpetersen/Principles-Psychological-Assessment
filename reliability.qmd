...
(ref:blandAltmanCaption) Example of a Bland-Altman Plot. (Figure reprinted from @Vaz2013, Figure 2, p. 4. Vaz, S., Falkmer, T., Passmore, A. E., Parsons, R., & Andreou, P. (2013). The case for using the repeatability coefficient when calculating test–retest reliability. *PLoS ONE*, *8*(9), e73990. <https://doi.org/10.1371/journal.pone.0073990>)
