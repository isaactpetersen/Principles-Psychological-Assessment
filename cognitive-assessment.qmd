...
# Assessment of Cognition {#sec-cognition}

## Overview of Cognition {#sec-overview-cognition}
...
## Aspects of Cognition Assessed {#sec-cognitionAspects}
...
The person's cognitive structures may include "danger" schemas that, when activated, lead to attention [bias](#sec-bias) toward threat stimuli.\index{cognition}\index{bias!attentional}
Though, this finding is under question because of challenges to the [reliability](#sec-reliability) of the dot-probe task, which has been frequently used to examine attentional [bias](#sec-bias).\index{cognition}\index{reliability}\index{bias!attentional}

## Approaches to Assessing Cognition {#sec-cognitionApproaches}
...
### Self-Reports of Cognition {#sec-cognitionSelfReport}
...
#### Pros {#sec-cognitionSelfReportPros}
...
Cognitive therapy advocates would argue that changes in cognitions mediate treatment changes (i.e., they are thought to be a causal mechanism that explains how therapy works).\index{cognitive assessment}\index{self-report}
 - They are standardized, [normed](#sec-norm), and have been psychometrically validated.\index{cognitive assessment}\index{self-report}\index{norm}\index{standardization}

#### Cons {#sec-cognitionSelfReportCons}
...
Findings such as these challenge the [validity](#sec-validity) of self-reported cognition.\index{cognitive assessment}\index{self-report}\index{cognitive assessment!validity}
...
### Think-Aloud Approaches (Thought Listing) {#sec-cognitionThinkAloud}
...
The act of re-watching a video of oneself can be strange, and there is commonly [reactivity](#sec-reactivity) to that.\index{cognitive assessment}

##### Private Speech {#sec-cognitionThinkAloudPrivateSpeech}
...
#### Pros {#sec-cognitionThinkAloudPros}

Pros of think-aloud approaches include:\index{cognitive assessment}

- Participants are asked to report on cognitions at the same time or just after the thoughts are occurring, so they are less sensitive to retrospective recall [bias](#sec-bias).\index{cognitive assessment}\index{retrospective}\index{bias}
...
#### Cons {#sec-cognitionThinkAloudCons}
...
- Social desirability [bias](#sec-bias): people may censor negative or disturbing thoughts and may describe their thoughts in a way that portrays themselves in a more positive light.\index{cognitive assessment}\index{bias!social desirability}
...
- Think-aloud approaches tend to be lower in [ecological validity](#sec-ecologicalValidity) because they typically occur in the lab rather than in a naturalistic context.\index{cognitive assessment}\index{validity!ecological}

### Random Thought Sampling {#sec-cognitionRandomThoughtSampling}

The purpose of thought sampling is to quantify characteristics or aspects of thinking in an [ecologically valid](#sec-ecologicalValidity) context.\index{cognitive assessment}
By [ecologically valid](#sec-ecologicalValidity), we mean that the situation closely represents the specific situations under which the person usually exists.\index{cognitive assessment}\index{validity!ecological}
...
#### Pros {#sec-cognitionRandomThoughtSamplingPros}
...
- The situations are [ecologically valid](#sec-ecologicalValidity) in that they are occurring in situations that the person actually experiences, rather than a lab.\index{cognitive assessment}\index{validity!ecological}
...
- A client's [reactivity](#sec-reactivity) could show therapeutic benefit.\index{cognitive assessment}\index{reactivity}

#### Cons {#sec-cognitionRandomThoughtSamplingCons}
...
- Random thought sampling could elicit [reactivity](#sec-reactivity) such that thinking about one's thoughts could change thoughts or create thoughts.\index{cognitive assessment}\index{reactivity}
...
- Because random thought sampling typically occurs in an [ecologically valid](#sec-ecologicalValidity) context, the experimenter has less experimental control of the situation, context, and stimuli.\index{cognitive assessment}\index{validity!ecologically valid}
...
### Cognitive Science Approaches {#sec-cognitionCognitiveScience}
...
#### Performance-Based Measures {#sec-performanceBased}
...
#### Cognitive Modeling {#sec-cognitionModeling}
...
It can be difficult to use multiple behavioral tasks to decompose basic processes because any task taps multiple cognitive processes, including likely overlapping processes, and each is affected by [measurement error](#sec-measurementError).\index{cognitive assessment!modeling}\index{measurement error}
...
Emerging approaches for cognitive modeling include use of artificial intelligence [@Frank2026].\index{artificial intelligence}

#### Challenges {#sec-challenges-cognition}
...
##### Reliability of Difference Scores {#sec-differenceScores}
...
The problem is that difference scores tend to be lower in [reliability](#sec-reliability) than other scores because differences depend on the [reliability](#sec-reliability) of both indices in the subtraction, as described in @sec-differenceScore-reliability.\index{cognitive assessment!challenges}\index{difference score!reliability}
Difference scores tend to be lower in [reliability](#sec-reliability) than each of the indices that compose it, especially when the two indexes are correlated.\index{cognitive assessment!challenges}\index{difference score!reliability}
Therefore, scores on these tasks tend to be less [reliable](#sec-reliability) than scores on other tasks that do not involve difference scores.\index{cognitive assessment!challenges}\index{difference score!reliability}
To be [reliable](#sec-reliability), difference scores require high [reliability](#sec-reliability) of the individual indices compared to the correlation between them.\index{cognitive assessment!challenges}\index{difference score!reliability}
Otherwise said, the more two things are the same thing, the more likely that subtracting one from the other leaves [measurement error](#sec-measurementError) rather than construct variance.\index{cognitive assessment!challenges}\index{difference score!reliability}\index{measurement error}

As an alternative to difference scores, researchers can examine [residualized change scores](#sec-residualizedChange).
In addition, researchers have developed accuracy-based and adaptive assessments for attention control that do not use difference scores or speeded responding and thus show stronger [reliability](#sec-reliability) [@Draheim2024].

Because of the reliance of difference scores in the dot-probe task, @Rodebaugh2016 challenged whether attention [bias](#sec-bias) toward threat exists or whether it is [stable](#sec-stability) across time for those with anxiety.\index{cognitive assessment!challenges}\index{difference score!reliability}\index{stability!rank-order}\index{bias!attentional}

##### Reliability Paradox {#sec-reliabilityParadox}

Another challenge with performance-based assessments of cognition is known as the [reliability](#sec-reliability) paradox [@Hedge2018].\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}
...
That is, their scores are not [reliable](#sec-reliability) for a particular person.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}
Low [reliability](#sec-reliability) precludes making strong inferences and decisions about individuals and calls into question the [validity](#sec-validity) of inferences regarding individual differences, or people's change, in scores on those tasks.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}

The *reliability paradox* is that despite some robust cognitive tasks showing well-established experimental effects, many of these tasks do not produce [reliable](#sec-reliability) individual differences, including the Flanker task, Stroop task, and stop-signal task, etc.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}
...
However, low between-subject variability leads to low [reliability](#sec-reliability) of individual differences.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}
The [stability](#sec-stability) coefficient, i.e., [test–retest reliability](#sec-testRetest-reliability), an index of [reliability](#sec-reliability) of individual differences relies on a Pearson correlation.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}\index{reliability!test–retest!coefficient of stability}
As described in @sec-correlationConsiderations, correlation requires variability: restricted range leads to weaker associations.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}
...
Moreover, the poor [test–retest reliability](#sec-testRetest-reliability) of many performance-based assessments is exacerbated by the use of difference scores.
Because many tasks using reaction times use difference scores, their reliability tends to be poor [@Draheim2019].
Moreover, reaction times are subject to speed-accuracy tradeoffs, which are ignored when examining only reaction time [@Draheim2019].
Researchers are thus advised against using reaction time-based measures [@Draheim2019].

The implications of the [reliability](#sec-reliability) paradox are that many well-established approaches in experimental, cognitive, and neuropsychology may not translate well to the study of individual differences, even though the measures can be useful for making group-level inferences.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}
It is important to know the [reliability](#sec-reliability) of your measures, especially when dealing with issues of trying to understand where a particular person stands on the construct relative to other people.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}

[Unreliability](#sec-reliability) and [measurement error](#sec-measurementError) are threats to science and knowledge.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}\index{measurement error}
[Unreliability](#sec-reliability) leads to false inferences and failures to replicate findings.\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}\index{restricted range}\index{measurement error}
As described in @sec-effectOfMeasurementErrorOnAssociations, and formalized with the attenuation formula (@eq-attenuationFormula), associations with other variables are weakened to the extent that [measurement error](#sec-measurementError) exists.\index{association!attenuation of}\index{measurement error}
If you know the degree of [unreliability](#sec-reliability), you can account for it using the disattenuation formula (@eq-disattenuationFormula), to get more accurate estimates of the true associations with other variables.\index{association!disattenuation of}\index{measurement error}

It is important to test the [reliability](#sec-reliability) of your measures and report the [reliability](#sec-reliability) in papers.\index{reliability!reporting}\index{reporting}
Continually work to improve the [reliability](#sec-reliability) of your measures.\index{reliability!ways to increase}
There are attempts to improve the [reliability](#sec-reliability) of measures of basic cognitive processes like those assessing attention control [@Burgoyne2023].\index{cognitive assessment!challenges}\index{reliability!paradox}\index{performance-based assessment!reliability}
Ways to improve the reliability of measures are described in @sec-increaseReliability.\index{reliability!ways to increase}
Another way to improve [reliability](#sec-reliability) of scores is to aggregate multiple measures using a multimethod approach in [structural equation modeling](#sec-sem).\index{reliability!ways to increase}\index{structural equation modeling}\index{aggregation}\index{methods!multiple}

### Cognitive Neuroscience Approaches {#sec-cognitionNeuroscience}
...
Cognitive neuroscience techniques are discussed in @sec-psychophysiological.\index{cognitive neuroscience}
Cognitive neuroscience is a high priority of the National Institute of Mental Health with their emphasis on the [Research Domain Criteria](#sec-rdoc) (RDoC).\index{cognitive neuroscience}\index{Research Domain Criteria}
...
## Conclusion {#sec-conclusion-cognition}

Multiple [aspects of cognition](#sec-cognitionAspects) can be assessed, including cognitive products, processes, and structures or organization.\index{cognition}
The general [approaches to assessing](#sec-cognitionApproaches) cognition include endorsement methods and production methods.\index{cognitive assessment}
[Cognitive assessments](#sec-cognitionApproaches) include [self-report](#sec-cognitionSelfReport), [think-aloud approaches](#sec-cognitionThinkAloud), [random thought sampling](#sec-cognitionRandomThoughtSampling), [performance-based measures](#sec-performanceBased), [cognitive modeling](#sec-cognitionModeling), and [cognitive neuroscience](#sec-cognitionNeuroscience) approaches.\index{cognitive assessment}\index{cognitive assessment!modeling}\index{performance-based assessment}\index{cognitive neuroscience}
One challenge related to the use of [performance-based assessment](#sec-performanceBased) of cognition is that many such tasks involve [difference scores](#sec-differenceScores), which tend to be lower in [reliability](#sec-reliability) than each of the indices that compose it.\index{performance-based assessment!reliability}\index{difference score!reliability}
Another challenge with [performance-based assessments](#sec-performanceBased) of cognition is known as the [reliability paradox](#sec-reliabilityParadox) that despite some robust cognitive tasks showing well-established experimental effects, many of these tasks do not produce [reliable](#sec-reliability) individual differences due to low between-subject variability and the use of difference scores.\index{performance-based assessment}\index{reliability!paradox}

## Suggested Readings {#sec-readings-cognition}
