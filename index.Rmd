...
knitr::write_bib(c(
  .packages(), "bookdown", "knitr", "rmarkdown", "tidyverse", "readr", "here", "psych", "MBESS", "rms", "lavaan", "semPlot", "semTools", "semPlot", "simsem", "dagitty", "dmacs", "mirt", "mirtCAT", "blandr", "gtheory", "rockchalk", "pROC", "ROCR", "ResourceSelection", "PredictABEL", "snow", "mice", "grid", "gridExtra", "corrplot", "nFactors", "tinytex", "kableExtra", "DT", "tufte", "servr", "MOTE", "Cairo", "irrCAC", "MASS", "lme4"
), 'packages_new.bib')
```
