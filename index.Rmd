...
knitr::write_bib(c(
  .packages(), "bookdown", "knitr", "rmarkdown", "psych", "MBESS", "rms", "lavaan", "semPlot", "semTools", "semPlot", "simsem", "dagitty", "dmacs", "mirt", "mirtCAT", "blandr", "gtheory", "rockchalk", "pROC", "ResourceSelection", "PredictABEL", "snow", "mice", "grid", "gridExtra", "corrplot", "nFactors", "mnlfa", "aMNLFA", "tidyverse", "tinytex", "kableExtra", "DT", "tufte", "servr", "MOTE" #, "MASS"
), 'packages_new.bib')
```
