...
# Projective Personality Testing {#sec-projective}

## Overview of Projective Personality Testing {#sec-overview-projective-personality}
...
### Categorization of Responses {#sec-projectiveCategorization}
...
### Projective Hypothesis {#sec-projectiveHypothesis}

Psychodynamic theorists are less concerned with psychometrics ([reliability](#sec-reliability) and [validity](#sec-validity)) from statistical correlations across many people.\index{personality assessment!projective}\index{reliability}\index{validity}\index{psychoanalysis!projection}\index{psychoanalysis}
...
They would argue that the projective measures are [valid](#sec-validity) if the examinee provides similar response configurations across stimuli and situations.\index{personality assessment!projective}\index{validity}\index{psychoanalysis!projection}\index{psychoanalysis}
...
An ancillary hypothesis to the projective hypothesis is that indirect responses are more [valid](#sec-validity) than direct responses.\index{personality assessment!projective}\index{psychoanalysis!projection}\index{validity}
...
### Projective Measures {#sec-projectiveMeasures}
...
Examples of projective measures include the [Rorschach Inkblot Test](#sec-rorschach), the [Thematic Apperception Test](#sec-tat) (TAT), Draw-A-Person Test, and drawing a family (Kinetic Family Drawing).\index{personality assessment!projective}\index{Rorschach Inkblot Test}\index{Thematic Apperception Test}
...
- well-calibrated [norms](#sec-norm) for comparing responses with those of other people\index{personality assessment!projective}\index{norm}
...
- construction techniques, often with artistic media—e.g., human figure drawing or story creation methods like the [Thematic Apperception Test](#sec-tat) (TAT).\index{personality assessment!projective}
...
The [Rorschach Inkblot Test](#sec-rorschach) is a classic example of a projective measure.\index{personality assessment!projective}\index{Rorschach Inkblot Test}
...
The [Rorschach Inkblot Test](#sec-rorschach) has low [face validity](#sec-faceValidity), and is therefore potentially difficult to fake.\index{personality assessment!projective}\index{Rorschach Inkblot Test}\index{validity!face}
...
Examiners were trying to decide if the patient was psychotic, and they interpret her [crystallized intelligence](#sec-fluidCrystallizedIntelligence) from the Wechsler Adult Instelligence Scale based on [Rorschach](#sec-rorschach) scores ("insufficiency of ego strength").\index{personality assessment!projective}\index{Rorschach Inkblot Test}\index{intelligence!Wechsler scales}\index{intelligence!crystallized}
...
### Why Not Use Projective Measures? {#sec-whyNotUseProjectiveMeasures}
...
Second, unlike other [observational](#sec-behavioral) and performance-based measures, projective measures provide very little information.\index{personality assessment!projective}
...
Instead of relying on the client to report relatively color-less items in the [Rorschach](#sec-rorschach), why not ask them (and others) how their mood is and observe their energy and affect?\index{personality assessment!projective}\index{self-report}\index{observation}\index{Rorschach Inkblot Test}
Thus, projective measures have an [incremental validity](#sec-incrementalValidity) problem.\index{personality assessment!projective}\index{validity!incremental}
The scientific status of projective measures is described in further detail later in the chapter in @sec-projectiveScientificStatus.\index{personality assessment!projective}

## Examples of Projective Measures {#sec-projectiveMeasureExamples}

In this chapter, two projective measures are described in detail.\index{personality assessment!projective}
The first is the [Rorschach Inkblot Test](#sec-rorschach) and the second is the [Thematic Apperception Test](#sec-tat) (TAT).\index{personality assessment!projective}\index{Rorschach Inkblot Test}\index{Thematic Apperception Test}

### Rorschach Inkblot Test {#sec-rorschach}
...
#### Variables {#sec-rorschachVariables}
...
John Exner [-@Exner1974] developed standardized rules for administration and scoring, which improved the [reliability](#sec-reliability) of scores.\index{Rorschach Inkblot Test!scoring}\index{Rorschach Inkblot Test!reliability}
...
R-PAS has limited research on its use by those outside of its developers, but it likely has similar problems with [validity](#sec-validity) and [utility](#sec-treatmentUtility).\index{Rorschach Inkblot Test!scoring}\index{Rorschach Inkblot Test!validity}\index{validity!utility}

### Thematic Apperception Test (TAT) {#sec-tat}
...
So, unlike the [Rorschach](#sec-rorschach), storytelling is allowed in the TAT.\index{Thematic Apperception Test}\index{Rorschach Inkblot Test}
...
## Most Widely Used Assessments for Children {#sec-mostWidelyUsedAssessmentsChildren}
...
- [Child Behavior Checklist](#sec-behaviorRatingScales)\index{behavior rating scale}\index{Child Behavior Checklist}
- And then many projective techniques, including:
    ...
    - [Rorschach Inkblot Test](#sec-rorschach)\index{personality assessment!projective}\index{Rorschach Inkblot Test}
    - [Thematic Apperception Test](#sec-tat) (TAT)\index{personality assessment!projective}\index{Thematic Apperception Test}
...
## Evaluating the Scientific Status of Projective Measures {#sec-projectiveScientificStatus}
...
To evaluate the scientific status of the [Rorschach Inkblot Test](#sec-rorschach) (or any other projective measure), we would assess across several domains of evidence, as described below.\index{personality assessment!projective}\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}
Evaluation of the [Rorschach Inkblot Test](#sec-rorschach) is provided by Wood and colleagues [-@Wood1996; -@Wood1996a; -@Wood2001b].\index{personality assessment!projective}\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}

### Utility of Norms {#sec-projectiveNorms}

One consideration to evaluate is the utility of the [norms](#sec-norm).\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}
...
Of note, the [Rorschach](#sec-rorschach) does not correctly distinguish between those with and without maladaptive behavior, and it does not lead to unbiased estimates for ethnic minorities.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}
In addition, we cannot evaluate the [norms](#sec-norm) because they are not published.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}

In terms of the Exner [norms](#sec-norm), they showed somewhat higher [reliability](#sec-reliability) than the original [Rorschach](#sec-rorschach) [norms](#sec-norm), but they did not show strong evidence for [validity](#sec-validity).\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}\index{Rorschach Inkblot Test!validity}\index{Rorschach Inkblot Test!reliability}
The Exner [norms](#sec-norm) are not well-calibrated.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}
The Exner [norms](#sec-norm) result in over-diagnosis and over-pathologizing of normality.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}
And they are not representative and generalizable: there are ethnic and cultural [biases](#sec-bias).\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test}\index{norm}\index{bias}

### Reliability of Scores {#sec-projectiveReliability}

Another important consideration of projective measures is the [reliability](#sec-reliability) of scores.\index{personality assessment!projective!scientific status}
This would include evaluating both [inter-rater reliability](#sec-interrater-reliability) and [test–retest reliability](#sec-testRetest-reliability).\index{personality assessment!projective!scientific status}\index{reliability!inter-rater}\index{reliability!test–retest}
For the [Rorschach](#sec-rorschach), the [inter-rater reliability](#sec-interrater-reliability) depends on the subscale of diagnosis, and has to be much lower than that of [objective techniques](#sec-objective-personality), especially in field settings.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!reliability}\index{reliability!inter-rater}\index{personality assessment!objective}
Field [reliability](#sec-reliability) refers to [reliability](#sec-reliability) in actual practice rather than ideal [reliability](#sec-reliability) in optimal conditions of a controlled lab study.\index{personality assessment!projective!scientific status}\index{reliability}
The [reliability](#sec-reliability) and standardization of administration of the [Rorschach](#sec-rorschach) is also questionable.\index{personality assessment!projective!scientific status}\index{standardization}\index{Rorschach Inkblot Test!reliability}
The [test–retest reliability](#sec-testRetest-reliability) is also low—but high enough to be passable for research settings—but it should be used with caution in clinical diagnostic settings.\index{personality assessment!projective!scientific status}\index{reliability!test–retest}

### Influence of Measurement Error on Scores {#sec-projectiveMeasurementError}

Another important consideration is the influence of [measurement error](#sec-measurementError) on scores: one aspect of the [Rorschach](#sec-rorschach) in particular that can lead to [measurement error](#sec-measurementError) is the effect of response frequency on test [validity](#sec-validity).\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{measurement error}
...
### Validity {#sec-projectiveValidity}

A crucial consideration of the scientific status is their [validity](#sec-validity).\index{personality assessment!projective!scientific status}\index{validity}
[Validity](#sec-validity) is not a yes/no thing.\index{personality assessment!projective!scientific status}\index{validity}
It is important to ask what the [validity](#sec-validity) is for what purpose?\index{personality assessment!projective!scientific status}\index{validity}
[Rorschach](#sec-rorschach) responses can be moderately [valid](#sec-validity) indicators of creativity.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}
Projective drawings have moderate [validity](#sec-validity) for drawing ability.\index{personality assessment!projective!scientific status}
But are projective tests [valid](#sec-validity) for their typical purposes in clinical psychology?\index{personality assessment!projective!scientific status}
...
#### Criterion-Related Validity {#sec-criterionValidity-projective}

[Criterion-related validity](#sec-criterionValidity) would consider whether the diagnosis given on the basis of the [Rorschach](#sec-rorschach) aligns with an external criterion of an actual diagnosis.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{validity!criterion}
For the [Rorschach](#sec-rorschach), the answer is: not really.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}
...
Research designs comparing diagnostic versus control groups often over-estimate [predictive validity](#sec-predictiveValidity) of the [Rorschach](#sec-rorschach) compared to what it would be in practice because clinicians are typically interested in low [base rate](#sec-baseRate) phenomena for which predictive accuracy will be lower.\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{validity!predictive}\index{base rate}

#### Convergent Validity {#sec-convergentValidity-projective}

[Convergent validity](#sec-convergentValidity) would consider whether [Rorschach](#sec-rorschach) findings correspond to the findings of more [reliable](#sec-reliability) [objective](#sec-objective-personality) tests such as the [Minnesota Multiphasic Personality Inventory](#sec-mmpi)?\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{validity!convergent}\index{Minnesota Multiphasic Personality Inventory}
...
#### Incremental Validity {#sec-incrementalValidity-projective}

In terms of [incremental validity](#sec-incrementalValidity), a frequent argument by proponents of projective tests is that, "I don't use the [Rorschach](#sec-rorschach)/[TAT](#sec-tat) in isolation but in combination with other measures".\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{Thematic Apperception Test}\index{validity!incremental}
But does the inclusion of the [Rorschach](#sec-rorschach) lead to improvements in the [validity](#sec-validity) of diagnoses of clinicians?\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{validity!incremental}
...
In many cases, it has [*decremental* validity](#sec-incrementalValidity)—it decreases predictive or diagnostic accuracy [@Garb2005a].\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!validity}\index{validity!incremental}

#### Treatment Utility {#sec-treatmentUtility-projective}

[Treatment utility](#sec-treatmentUtility) considers whether it is worth the vast amount of time spent administering, scoring, and interpreting the measure (2–3 hours)?\index{personality assessment!projective!scientific status}\index{Rorschach Inkblot Test!utility}\index{validity!utility}
...
### Summary {#sec-scientificStatusSummary-projective}

Hence, we would not say the scientific status of the [Rorschach](#sec-rorschach) is very positive.\index{personality assessment!projective!scientific status}
...
Considering the important role that assessments can play in clinical decision-making that influences people's lives, it seems [unethical](#sec-useOfAssessments-APA) to use projective techniques, as they are currently designed and used.\index{personality assessment!projective!scientific status}\index{ethics}

## Conclusion {#sec-conclusion-projective-personality}
...
Projective measures aim to bypass defense mechanisms so that they assess characteristics the person has and which the person is not consciously aware of.\index{personality assessment!projective}\index{psychoanalysis!defense mechanism}
Examples of projective measures include the [Rorschach Inkblot Test](#sec-rorschach), the [Thematic Apperception Test](#sec-tat) (TAT), Draw-A-Person Test, and drawing a family (Kinetic Family Drawing).\index{personality assessment!projective}\index{Rorschach Inkblot Test}\index{Thematic Apperception Test}
However, there are many problems with projective measures: most projective techniques do **not** have standardized stimuli and testing instructions, systematic algorithms for scoring responses to stimuli, or well-calibrated [norms](#sec-norm) for comparing responses with those of other people.\index{personality assessment!projective}\index{personality assessment!projective!scientific status}\index{standardization}\index{norm}
Their [scientific status](#sec-projectiveScientificStatus) is not strong in terms of [utility of norms](#sec-projectiveNorms), [reliability](#sec-projectiveReliability), [influence of measurement error](#sec-projectiveMeasurementError), or [validity](#sec-projectiveValidity).\index{personality assessment!projective}\index{personality assessment!projective!scientific status}\index{norm}\index{validity}\index{reliability}\index{measurement error}
...
## Suggested Readings {#sec-readings-projective-personality}
