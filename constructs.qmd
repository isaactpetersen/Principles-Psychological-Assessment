...
Thus, the latent factor is estimated to reflect the common variance among the indicators, as depicted in Figure \@ref(fig:latentVariableReflective).\index{construct!reflective}\index{structural equation modeling!indicator}
...
```{r latentVariableReflective, out.width = "100%", fig.align = "center", fig.cap = "Reflective Latent Variable as the Common Variance Among Indicators.", echo = FALSE}
knitr::include_graphics("./images/latentVariable_reflective.png")
```
...
A formative construct is estimated as the total variance among the indicators, as depicted in Figure \@ref(fig:latentVariableFormative).\index{construct!reflective}\index{structural equation modeling!indicator}
...
```{r latentVariableFormative, out.width = "100%", fig.align = "center", fig.cap = "Formative Latent Variable as the Total Variance Among Indicators.", echo = FALSE}
knitr::include_graphics("./images/latentVariable_formative.png")
```
