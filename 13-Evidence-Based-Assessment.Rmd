...
To avoid redundancy with rating scales, you can "take the best"—i.e., include only the most valid rating scale from each informant to test each hypothesis to avoid high inter-correlations and [multicollinearity](#multiCollinearity).\index{multicollinearity}
