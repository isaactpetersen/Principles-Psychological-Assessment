...
### Kaiser-Meyer-Oklin (KMO) Test {#kmoTest}
...
### Determinant of a Correlation Matrix {#determinantFactorAnalysis}
...
### Bartlett's Test of Sphericity {#bartlettTest}
...
###### `psych` {#modelFitOrthogonalPsych-efa}
...
###### `lavaan` {#modelFitOrthogonalLavaan-efa}
...
###### `psych` {#modelFitObliquePsych-efa}
...
###### `lavaan` {#modelFitObliqueLavaan-efa}
...
##### Bifactor Indices {#bifactorModelIndices}
...
##### Bifactor Indices {#mtmmCFAModelIndices}
...
## Benefits of Factor Analysis {#benefits-factorAnalysis}
...
2. For exercises about [confirmatory factor analysis](#sec-cfa), see the exercises in Section \#ref(semExercises) of the chapter on [Structural Equation Modeling](#sec-sem).
