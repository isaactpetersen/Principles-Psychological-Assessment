...
The base rate of a classification is its marginal probability, independent of other things: $P(C_i)$. In clinical psychology, the base rate of a disorder is its prevalence in the population. The base rate is used as the initial *pretest probability*.
