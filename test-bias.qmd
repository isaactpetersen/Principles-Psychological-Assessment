...
- item 4 has higher [difficulty/severity](#sec-itemDifficulty) ($b_1$ and $b_2$ parameters) among males than females\index{item response theory!differential item functioning}\index{item response theory!item difficulty}
...
Based on the analyses above, item 5 shows the largest magnitude of [DIF](#sec-dif).
