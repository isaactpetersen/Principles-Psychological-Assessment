...
Estimates of [differential item functioning](#sec-dif) are in Table \@ref(tab:itemLevelDIF).\index{item response theory!differential item functioning}
...
Estimates of [DIF](#sec-dif) after resolving item 5 are in Table \@ref(tab:itemLevelDIFAfterResolving).\index{item response theory!differential item functioning}
