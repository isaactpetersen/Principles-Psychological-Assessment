...
A [confusion matrix](#sec-confusionMatrix) for whom to select for a job is depicted in Figure \@ref(fig:jobSelection).\index{confusion matrix}
...
We can also visualize the [confusion matrix](#sec-confusionMatrix) in terms of a scatterplot of the test scores (i.e., predicted job performance) and the "truth" scores (i.e., actual job performance), as depicted in Figure \@ref(fig:jobSelection2).\index{confusion matrix}\index{bias!predictive}
...
[Receiver operating characteristic (ROC) curves](#sec-roc) are depicted for two groups in Figure \@ref(fig:testBias-ROC).\index{fairness!operationalizing}\index{receiver operating characteristic curve}
A cutoff that represents equal opportunity is depicted with a horizontal line (i.e., the same [sensitivity](#sec-sensitivity)) in Figure \@ref(fig:testBias-ROC).
...
A cutoff that represents equal odds is depicted where the [ROC curve](#sec-roc) for Group A intersects with the [ROC curve](#sec-roc) from Group B in Figure \@ref(fig:testBias-ROC).\index{fairness!operationalizing}
...
An example of using [banding](#sec-banding) with [bonus points](#sec-bonusPoints) as a score adjustment is depicted in Figure \@ref(fig:bandingBonusPoints).\index{bias!correcting for}\index{bias!correcting for!score adjustment}\index{bias!correcting for!banding with bonus points}\index{bias!correcting for!banding}\index{bias!correcting for!bonus points}
...
In the example depicted in Figure \@ref(fig:differentMeasurementError), there are differences in the measurement [reliability](#sec-reliability)/[error](#sec-measurementError) on the criterion between males and females: males' scores have a lower [reliability](#sec-reliability) (higher [measurement error](#sec-measurementError)) on the criterion than females' scores.\index{bias!predictive!different measurement error}\index{measurement error}\index{reliability}
...
The [DIF](#sec-dif) in [discrimination](#sec-itemDiscrimination) and/or [severity](#sec-itemDifficulty) is depicted in Figure \@ref(fig:difAddDiscriminationSeverity).\index{item response theory!differential item functioning}\index{item response theory!item discrimination}\index{item response theory!item difficulty}
...
The [DIF](#sec-dif) in [discrimination](#sec-itemDiscrimination) is depicted in Figure \@ref(fig:difAddDiscrimination).\index{item response theory!differential item functioning}\index{item response theory!item discrimination}
...
The [DIF](#sec-dif) in [difficulty/severity](#sec-itemDifficulty) is depicted in Figure \@ref(fig:difAddSeverity)\index{item response theory!differential item functioning}\index{item response theory!item difficulty}
...
[Differential item functioning](#sec-dif) is depicted in Figure \@ref(fig:dif).\index{item response theory!differential item functioning}\index{effect size}
...
Plots of item [information](#sec-irtReliability) functions by sex are in Figures \@ref(fig:itemInfo1)–\@ref(fig:itemInfo7) below.\index{item response theory!differential item functioning}\index{item response theory!item information curve}
