...
round(cbind(
  null = inspect(nullModelFit, "fit.measures"),
  configural = inspect(configuralInvarianceModel_fit, "fit.measures"), 
  weak = inspect(metricInvarianceModel_fit, "fit.measures"),
  strong = inspect(scalarInvarianceModel_fit, "fit.measures"),
  strict = inspect(residualInvarianceModel_fit, "fit.measures")), 3)
```
