...
for (j in seq_len(numColumns)) {
  if (is.numeric(difDropItems[, j])) difDropItems[, j] <- paste("$", round(difDropItems[, j], 2), "$", sep = "")
}
...
digits <- rep(2, length.out = numColumns)
for (j in seq_len(numColumns)) {
  if (is.numeric(difDropItemsDiscrimination[, j])) difDropItemsDiscrimination[, j] <- paste("$", round(difDropItemsDiscrimination[, j], 2), "$", sep = "")
}
...
digits <- rep(2, length.out = numColumns)
for (j in seq_len(numColumns)) {
  if (is.numeric(difDropItemsSeverity[, j])) difDropItemsSeverity[, j] <- paste("$", round(difDropItemsSeverity[, j], 2), "$", sep = "")
}
...
digits <- rep(2, length.out = numColumns)
for (j in seq_len(numColumns)) {
  if (is.numeric(itemLevelDIF[, j])) itemLevelDIF[, j] <- paste("$", itemLevelDIF[, j], "$", sep = "")
}
...
digits <- rep(2, length.out = numColumns)
for (j in seq_len(numColumns)) {
  if (is.numeric(difDropItemsNew[, j])) difDropItemsNew[, j] <- paste("$", round(difDropItemsNew[, j], 2), "$", sep = "")
}
