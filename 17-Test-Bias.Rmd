...
Plots of item response category characteristic curves by sex are in Figures \@ref(fig:ircSex1)–\@ref(fig:ircSex7).\index{item response theory!differential item functioning}\index{item response theory!item response category characteristic curve}
...
Plots of item [information](#irtReliability) functions by sex are in Figures \@ref(fig:itemInfo1)–\@ref(fig:itemInfo7).\index{item response theory!differential item functioning}\index{item response theory!item information curve}
...
Plots of expected item scores by sex are are in Figures \@ref(fig:itemScore1)–\@ref(fig:itemScore7).\index{item response theory!differential item functioning}
