...
Thus, it would be helpful to know whether the instrument shows measurement invariance across a similar timeframe when not treatment is occurring.\index{bias!correcting for}
