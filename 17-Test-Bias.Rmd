...
Estimates of [differential item functioning](#dif) are given in Table \@ref(tab:itemLevelDIFAfterResolving).\index{item response theory!differential item functioning}
