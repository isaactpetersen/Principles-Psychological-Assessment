...
The common variance is called the communality, which is the factor variance, where $1 - \text{communality}$ is the amount of variance due to error.
...
4. The factor scores from the CFA model are correlated $r = .97$ and $r = .98$ with the factor scores of the EFA model and the component scores of the PCA model, respectively.
