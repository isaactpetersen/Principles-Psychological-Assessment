...
## Factor scores
as_tibble(lavPredict(measurementModelCorrelatedErrors1Fit))
...
cor(cbind(efa1factorOblique_ex$scores, as_tibble(lavPredict(measurementModelCorrelatedErrors1Fit)), pca1factorOblique_ex$scores), use = "pairwise.complete.obs")
```
