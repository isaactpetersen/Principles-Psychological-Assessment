...
It was a long process—it took Spearman around one year to calculate the first [factor analysis](#factorAnalysis)! [Factor analysis](#factorAnalysis) takes a large dimension dataset and simplifies into smaller constructs.
...
```{r}
cor.table(HolzingerSwineford1939[,c("x1","x2","x3","x4","x5","x6","x7","x8","x9")], dig = 2)
cor.table(HolzingerSwineford1939[,c("x1","x2","x3","x4","x5","x6","x7","x8","x9")], type = "manuscript", dig = 2)
cor.table(HolzingerSwineford1939[,c("x1","x2","x3","x4","x5","x6","x7","x8","x9")], type = "manuscriptBig", dig = 2)
```
...
```{r, out.width = "100%", fig.cap = "Factor Flot With Oblique Rotation in Exploratory Factor Analysis."}
...
###### Estimates of model fit {#classExamplesModel2fit-cfa}
