...
[EFA](#efa) and [CFA](#cfa) can be considered special cases of exploratory structural equation modeling (ESEM), which combines features of [EFA](#efa), [CFA](#cfa), and [SEM](#sem) [@Marsh2014]. ESEM can include any combination of ESEM and [CFA](#cfa) factors. If a [CFA](#cfa) model fits as well as an ESEM model, the [CFA](#cfa) model should be retained for its simplicity (i.e., no cross-loadings). However, ESEM models often fit better than [CFA](#cfa) models because requiring no cross-loadings is an unrealistic expectation of items from many psychological instruments [@Marsh2014].
