...
A scree plot from a [factor analysis](#factorAnalysis) or [PCA](pca) provides lots of information. A scree plot has the factor number on the x-axis and the eigenvalue on the y-axis. The eigenvalue is the variance accounted for by a factor, and is calculated as the sum of squared factor (or component) loadings. An example of a scree plot is in Figure \@ref(fig:screePlot).
