...
The person's cognitive structures may include "danger" schemas that, when activated, lead to attention [bias](#bias) toward threat stimuli.\index{cognitions}\index{bias!attentional}
Though, this finding is under question because of challenges to the [reliability](#reliability) of the dot-probe task, which has been frequently used to examine attentional [bias](#bias).\index{cognitions}\index{reliability}\index{bias!attentional}
