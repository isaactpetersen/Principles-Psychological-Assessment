...
The cognitive therapy component of CBT assumes that thoughts mediate the influences of the environment on emotions and behavioral responses.\index{cognitions}
In general, cognitions and cognitive processes play a key role in many psychological theories.\index{cognitions}
Therefore, cognitions and distorted cognitions are assumed to be a key construct to assess.\index{cognitions}
However, there are many challenges to cognitive assessment.\index{cognitive assessment}
Some consider cognitions to be fictitious entities or epiphenomenal to people's experience—i.e., that is, they are not a causal process, but rather they are a by-product of neural and biological processes.\index{cognitions}

## Aspects of Cognition Assessed {#cognitionAspects}

Multiple aspects of cognition can be assessed, including cognitive products, processes, and structures or organization.\index{cognitions}
Cognitive products include a person's conscious thoughts or imaginal images.\index{cognitions}
Cognitive processes include how a person transforms the environmental input and how they take meaning from it.\index{cognitions}
Cognitive structures and organization include the hypothesized structures that a person has to guide information processing.\index{cognitions}

Consider an example of a person with an anxiety disorder.\index{cognitions}
Cognitive products for the person may include having the thought, "I'm going to make a fool of myself, and everyone will think I'm stupid."\index{cognitions}
The person's cognitive processes may involve the over-estimation of personal risk.\index{cognitions}
The person's cognitive structures may include "danger" schemas that, when activated, lead to attention [bias](#bias) toward threat stimuli.\index{cognitions}
Though, this finding is under question because of challenges to the [reliability](#reliability) of the dot-probe task, which has been frequently used to examine attentional [bias](#bias).\index{cognitions}\index{reliability}\index{bias}
...
The constraints are made in terms of how the thoughts are coded and analyzed by the experimenter, not in the unstructured and open-ended thoughts that the participant can provide\index{cognitive assessment}
- Specific situations of interest to the research team can be explored.\index{cognitive assessment}
For example, the examiner can examine the respondent in situations that are thought to evoke particular cognitive processes, including situations that might be impractical due to low frequency or unethical to assess in their natural context.\index{cognitive assessment}
...
- Performance is susceptible to observer effects.\index{cognitive assessment}\index{observer effects}
Observer effects are changes in the person's response because they are being watched or recorded.\index{cognitive assessment}\index{observer effects}
...
These cognitive science approaches are different from the approaches described earlier they do not rely on respondents reporting their thoughts.\index{cognitive assessment!modeling}\index{performance-based assessment}\index{cognitive neuroscience}\index{self-report}
...
Performance-based measures are used to assess attention, executive functions, inhibitory control, memory, decision making, categorization, etc.\index{performance-based assessment}
...
In the Iowa Gambling Task, participants are presented with four virtual decks on computer screen.\index{cognitive assessment!modeling}
...
In performance-based assessments of cognition, many tasks subtract scores, especially accuracy or reactive time, in one condition from scores in another condition.\index{cognitive assessment!challenges}\index{difference score!reliability}\index{peformance-based assessment}
For example, the most-often used dependent variable in the Flanker task, Stroop task, stop-signal task, and dot probe task are difference scores.\index{cognitive assessment!challenges}\index{difference score!reliability}\index{peformance-based assessment}
For instance, in the Flanker task, the reaction time to incongruent (interference) stimuli is subtracted from the reaction time to congruent stimuli.\index{cognitive assessment!challenges}\index{difference score!reliability}\index{peformance-based assessment}
...
Therefore, scores on these tasks tend to be less [reliability](reliability) than scores on other tasks that do not involve difference scores.\index{cognitive assessment!challenges}\index{difference score!reliability}
...
If you know degree of [unreliability](#reliability), you can account for it using disattenuation formula (Equation \@ref(eq:disattenuationFormula)), to get more accurate estimates of the true associations with other variables.\index{association!disattenuation of}\index{measurement error}

It is important to test the [reliability](#reliability) of your measures and report the [reliability](#reliability) in papers.\index{reliability!reporting}
...
Another way to improve [reliability](#reliability) of scores is to aggregate multiple measures using a multi-method approach in [structural equation modeling](#sem).\index{reliability!ways to increase}\index{structural equation modeling}

### Cognitive Neuroscience Approaches {#cognitionNeuroscience}

Another branch of cognitive sciences approaches include cognitive neuroscience approaches.\index{cognitive neuroscience}
...
Another challenge with [performance-based assessments](#performanceBased) of cognition is known as the [reliability paradox](#reliabilityParadox) that despite some robust cognitive tasks showing well-established experimental effects, many of these tasks do not produce [reliable](#reliability) individual differences due to low between-subject variability.\index{performance-based assessment}\index{reliability!paradox}
