...
```{r mtmmCorrelationHTML, out.width = "100%", fig.align = "center", fig.cap = "Multitrait-Multimethod Correlation Matrix.", eval = knitr::is_html_output(excludes = "epub"), echo = knitr::is_html_output(excludes = "epub"), echo = FALSE}
paged_table(data.frame(round(cor(MTMM_data), 2)))
```

```{r mtmmCorrelationPDF, out.width = "100%", fig.align = "center", fig.cap = "Multitrait-Multimethod Correlation Matrix.", eval = knitr::is_latex_output(), echo = knitr::is_latex_output(), echo = FALSE}
kable(
