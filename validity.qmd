...
There is a classic and hilarious [Monty Python video](https://osf.io/gc79d) (see below) that is an absurd example akin to radical operationalism taken to the extreme.\index{empiricism}\index{radical operationalism}

![Monty Python video on penguin research](images/montyPythonPenguinResearch.mp4){width=100%}
...
```{r nomologicalNetwork, out.width = "100%", fig.align = "center", fig.cap = "Example of a Nomological Network. O.M. = Observable Manifestation.", fig.scap = "Example of a Nomological Network.", echo = FALSE}
...
(ref:campbellFiskeCaption) Multitrait-Multimethod Matrix. (Figure reprinted from Campbell and Fiske [-@Campbell1959], Table 1, p. 82. Campbell, D. T., & Fiske, D. W. (1959). Convergent and discriminant validation by the multitrait-multimethod matrix. *Psychological Bulletin*, *56*, 81–105. <https://doi.org/10.1037/h0046016>)

```{r campbellFiske, out.width = "100%", fig.align = "center", fig.cap = "(ref:campbellFiskeCaption)", fig.scap = "Multitrait-Multimethod Matrix.", echo = FALSE}
...
```{r semDisattenuation, out.width = "100%", fig.align = "center", fig.cap = "Disattenuation of an Observed Association Due to Measurement Error, as Depicted in a Structural Equation Model.", echo = FALSE}
knitr::include_graphics("./images/SEM-01.png")
```
