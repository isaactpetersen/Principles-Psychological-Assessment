...
@Revelle2024 argues that insufficient attention is paid to predictive validity due to excessive focus on [reflective latent variables](#sec-reflectiveConstruct) and [internal consistency](#sec-internalConsistency-reliability) as a means to satisfy considerations of [construct validity](#sec-constructValidity) at the expense of the usefulness of the measure.
