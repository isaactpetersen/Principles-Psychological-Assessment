...
In Figure \@ref(fig:overfittingModel), the blue line represents the true distribution of the data, and the red line is an over-fitting model:\index{over-fitting}
...
The organization of types of [measurement validity](#sec-measurementValidity) that are subsumed by [construct validity](#sec-constructValidity) is depicted in Figure \@ref(fig:constructValidityOrganization).\index{validity}\index{validity!measurement}\index{validity!organizational framework}\index{validity!construct}
...
The typical way of depicting the distinction between [reliability](#sec-reliability) and validity is in Figure \@ref(fig:reliabilityVsValidity2), in which a measure can either have (a) low [reliability](#sec-reliability) and low validity, (b) high [reliability](#sec-reliability) and low validity, or (c) high [reliability](#sec-reliability) and high validity.\index{validity}\index{reliability}
...
When we distinguish between person- versus group-level accuracy, we can distinguish four general combinations of [reliability](#sec-reliability) and validity, as depicted in Figure \@ref(fig:reliabilityVsValidity1): (a) low [reliability](#sec-reliability), low accuracy at the person level, and low accuracy at the group level, (b) low [reliability](#sec-reliability), low accuracy at the person level, and high accuracy at the group level, (c) high [reliability](#sec-reliability), low accuracy at the person level, and low accuracy at the group level, and (d) high [reliability](#sec-reliability), high accuracy at the person level, and high accuracy at the group level.\index{validity}\index{reliability}\index{individual level}\index{group level}
...
Figure \@ref(fig:validity) depicts the [classical test theory](#sec-ctt) approach to understanding the validity of a measure, i.e., its association with another measure, which is the validity coefficient ($r_{xy}$).\index{classical test theory}\index{validity!coefficient of}
...
A path diagram of the observed association is depicted in Figure \@ref(fig:observedSEM).\index{measurement error!disattenuation of association}\index{measurement error!random error}\index{true association}\index{observed association}\index{reliability}\index{validity!coefficient of}\index{structural equation modeling}
...
A path diagram of the true association is depicted in Figures \@ref(fig:disattenuationSEM) and \@ref(fig:semDisattenuation).\index{measurement error!disattenuation of association}\index{measurement error!random error}\index{true association}\index{observed association}\index{reliability}\index{validity!coefficient of}\index{structural equation modeling}
