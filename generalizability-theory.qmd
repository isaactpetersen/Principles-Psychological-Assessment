...
G-theory is also discussed in the chapters on [reliability](#sec-reliability) (Chapter \@ref(reliability), @sec-gTheoryReliability)), [validity](#sec-validity) (Chapter \@ref(validity), @sec-gTheoryValidity)) and [structural equation modeling](#sec-sem) (Chapter \@ref(sem), @sec-generalizability-SEM)).\index{generalizability theory}\index{reliability}\index{validity}\index{structural equation modeling}
...
#| tbl-cap: "Generalizability Theory Table."
