...
# Ethical Issues in Assessment {#sec-ethics}
...
Ethics provide a framework that guides us in moral behavior and knowing right from wrong [@QuantitudeS2E15].
Ethics are not always black and white; there is often considerable gray.
Ethical behavior is probably better conceptualized along a spectrum than a binary.
Nevertheless, there are many examples of highly problematic unethical behavior.
Ethics focuses on the morality of the *behavior*, not whether the person is good or bad.

## Belmont Report {#sec-belmontReport}
...
### Respect for Persons {#sec-respectForPersons}
...
## My Ethical Advice {#sec-myEthicalAdvice}
...
### Don't Do Stupid Things {#sec-dontDoStupidThings}
...
### Don't Do Bad Things {#sec-dontDoBadThings}
...
### Consult, Consult, Consult {#sec-consult}
...
## APA Ethics Code {#sec-APAethicsCode}
...
### Bases for Assessments {#sec-basesForAssessments-APA}
...
The current version of the APA record keeping guidelines was published in 2007 and is available here: <https://www.apa.org/pubs/journals/features/record-keeping.pdf> (archived at: <https://perma.cc/7A8U-M4TQ>).

### Use of Assessments {#sec-useOfAssessments-APA}
...
### Informed Consent in Assessments {#sec-informedConsent-APA}
...
### Release of Test Data {#sec-releaseOfTestData-APA}
...
### Other Guidelines {#sec-otherGuidelines-APA}
...
### Maintain Test Security (Integrity) {#sec-maintainTestSecurity-APA}
...
## AERA Guidelines {#sec-AERAguidelines}

## Clinical Report Writing {#sec-clinicalReportWriting}
...
Similar to a garden of forking paths (see @fig-gardenForkingPaths), there are so many decision points in a study, and different decisions can lead to drastically different results.\index{open science}
...
@Wicherts2016 provide a list of various researcher degrees of freedom, which can serve as a checklist against *p*-hacking.
...
However, there may be instances when it makes sense to deviate from a preregistered plan, such as when encountering unanticipated events.
@Lakens2024 provides guidance on when to deviate from a preregistered plan and how to report such deviations.
...
## Conclusion {#sec-conclusion-ethics}

According to the [Belmont Report](#sec-belmontReport), professional ethics includes [respect for persons](#sec-respectForPersons), [beneficence](#sec-beneficence), and [justice](#sec-justice).\index{ethics}\index{Belmont report}\index{respect for persons}\index{beneficence}\index{justice}
...
It is also important to produce a replicable science, which requires better science, including use of measures with strong psychometrics ([reliability](#sec-reliability) and [validity](#sec-validity)), in addition to not engaging in questionable research practices.\index{replication}\index{validity}\index{reliability}\index{ethics!questionable research practices}
The [open science](#sec-openScience) movement, including pre-registrations, sharing data, preprints, and research materials may help improve the replicability of science.\index{open science}\index{pre-registration}\index{preprint}

## Suggested Readings {#sec-readings-ethics}
