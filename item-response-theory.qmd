...
IRT forms the basis of [computerized adaptive testing](#sec-cat), which is discussed in Chapter \@ref(cat).\index{item response theory}\index{brief assessment}\index{adaptive testing}
