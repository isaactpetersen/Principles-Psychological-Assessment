...
A one-parameter logistic (1-PL) IRT model, similar to a Rasch model, estimates the [item difficulty](#sec-itemDifficulty) parameter, and holds everything else fixed across items (see Figure \@ref(fig:irt1PL)).\index{item response theory!one-parameter model}\index{item response theory!item difficulty}
...
A one-parameter logistic model is only valid if there is not crossing of lines in empirical [ICCs](#sec-icc) (see Figure \@ref(fig:empiricalICCnoCrossing)).\index{item response theory!one-parameter model}\index{item response theory!item characteristic curve}
...
A four-parameter logistic (4-PL) IRT model estimates item [difficulty](#sec-itemDifficulty), [discrimination](#sec-itemDiscrimination), [guessing](#sec-itemGuessing), and [careless errors](#sec-itemCarelessErrors) (see Figure \@ref(fig:irt4PL)).\index{item response theory!four-parameter model}\index{item response theory!item difficulty}\index{item response theory!item discrimination}\index{item response theory!item guessing}\index{item response theory!item careless errors}
...
Consider some hypothetical items depicted with [ICCs](#sec-icc) in Figure \@ref(fig:reliabilityIRTicc).\index{item response theory!item characteristic curve}
...
We can present the [ICC](#sec-icc) in terms of an item information curve (see Figure \@ref(fig:reliabilityIRTitemInformation)).\index{item response theory}\index{item response theory!item characteristic curve}\index{item response theory!information}\index{reliability}\index{item response theory!item information curve}
...
Based on test information, we can estimate the [reliability](#sec-irtReliability) (see Figure \@ref(fig:reliabilityIRTtestReliability)).\index{item response theory}\index{item response theory!item characteristic curve}\index{item response theory!information}\index{reliability}\index{reliability!standard error of measurement}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
Notice how the degree of [(un)reliability](#sec-reliability) differs at different construct levels.\index{item response theory}\index{item response theory!item characteristic curve}\index{item response theory!information}\index{reliability}\index{reliability!standard error of measurement}\index{item response theory!standard error of measurement}
...
An example of a bad measure for assessing the full range of individual differences is depicted in terms of [ICCs](#sec-icc) in Figure \@ref(fig:badMeasureICCs) and in terms of [test information](#sec-irtReliability) in Figure \@ref(fig:badMeasureInfo).\index{item response theory}\index{item response theory!information}\index{reliability}\index{item response theory!test information curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLsem).\index{reliability!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLtifSEM).\index{item response theory!information}\index{item response theory!standard error of measurement}\index{reliability!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:onePLicc) and \@ref(fig:onePLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:onePLiif) and \@ref(fig:onePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A path diagram of the one-parameter item factor analysis is in Figure \@ref(fig:onePLifa).\index{item response theory!one-parameter model}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLicc) and \@ref(fig:twoPLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLiif) and \@ref(fig:twoPLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalSEM).\index{item response theory!standard error of measurement}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on each latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLmultidimensionalICC) and \@ref(fig:twoPLmultidimensionalICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLmultidimensionalIIF) and \@ref(fig:twoPLmultidimensionalIIFfacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtif).\index{item response theory!information}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:threePLicc) and \@ref(fig:threePLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:threePLiif) and \@ref(fig:threePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:fourPLicc) and \@ref(fig:fourPLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:fourPLiif) and \@ref(fig:fourPLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelReliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelSEM).\index{item response theory!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelTIFsem).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the expected score on the item as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:gradedResponseModelICC) and \@ref(fig:gradedResponseModelICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:gradedResponseModelIIF) and \@ref(fig:gradedResponseModelIIFfacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A plot of the probability of item threshold endorsement as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelIRCCC).\index{item response theory!item response category characteristic curve}
...
A plot of item boundary characteristic curves is in Figure \@ref(fig:gradedResponseModelIOCC).\index{item response theory!item boundary characteristic curve}
...
A test characteristic curve ([TCC](#sec-icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorReliability).\index{reliability}
...
A plot of test [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorSEM).\index{reliability!standard error of measurement}
...
A plot of [test information](#sec-irtReliability) and [standard error of measurement](#sec-irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTIFsem).\index{item response theory!information}\index{item response theory!standard error of measurement}\index{reliability!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#sec-icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:bifactorICC) and \@ref(fig:bifactorICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:bifactorIIF) and \@ref(fig:onePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A path diagram of the bifactor item factor analysis is in Figure \@ref(fig:bifactorIFA).\index{factor analysis!confirmatory}\index{item response theory!bifactor model}\index{factor analysis!bifactor}
