...
Plots of [item information](#sec-irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures [-@fig-bifactorIIF] and [-@fig-onePLiifFacet].\index{item response theory!information}\index{item response theory!item information curve}
