...
message(paste0("mirt version:", as.character(packageVersion("mirt")), "\n"))
```
...
message(paste0("data folder exists: ", dir.exists("data"), "\n"))
message(paste0("object exists: ", exists("gradedResponseModel"), "\n"))

if (!exists("gradedResponseModel") || is.null(gradedResponseModel)) {
  message("gradedResponseModel not available; skipping downstream GRM output.")
} else {
