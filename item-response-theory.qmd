...
As a result, from the perspective of IRT, it does not make sense to talk about the [reliability](#reliability) of a scale, because the [reliability](#reliability) of the scale depends on the person's score on that scale.\index{item response theory}\index{classical test theory}\index{item response theory!information}\index{reliability}
...
If the respondent gets the first item correct, it moves to the next item that would provide the most [information](#irtReliability) for the person, based on a split of the remaining sample (e.g., 75th percentile).\index{adaptive testing}\index{reliability}\index{item response theory!information}
...
The measure is good for the intended purpose, in terms of having items that (a) span the range of interest (1–3 standard deviations above the mean of the latent construct), (b) have high [discrimination](#itemDiscrimination) and [information](#irtReliability), and (c) densely cover the range of interest without redundancy.\index{item response theory}\index{item response theory!information}\index{item response theory!item discrimination}\index{reliability}\index{item response theory!test information curve}
...
For instance, monotonicity can be evaluated using visual inspection of empirical [item characteristic curves](#icc).\index{item response theory!assumptions}\index{item response theory!item characteristic curve}
...
The dimensionality of a set of items can be evaluated using [factor analysis](#factorAnalysis).\index{item response theory!assumptions}\index{factor analysis}
...
These [multidimensional IRT models](#irt-twoPLmultidimensional) allow borrowing information from a given latent factor in the estimation of other latent factor(s) to account for the covariation.\index{item response theory!assumptions}\index{multidimensional}
...
The extent to which items may violate the item invariance assumption can be evaluated empirically using tests of [differential item functioning](#dif) (DIF).\index{item response theory!assumptions}\index{item response theory!differential item functioning}
Tests of [measurement invariance](#measurementInvariance) are the equivalent of tests of [differential item functioning](#dif) for [factor analysis](#factorAnalysis)/[structural equation models](#sem).\index{item response theory!assumptions}\index{item response theory!differential item functioning}\index{structural equation modeling!measurement invariance}\index{factor analysis}\index{structural equation modeling}
Test of [differential item functioning](#dif) and [measurement invariance](#measurementInvariance) are described in the chapter on [test bias](#bias).\index{item response theory!assumptions}\index{item response theory!differential item functioning}\index{structural equation modeling!measurement invariance}
...
[Factor analysis](#factorAnalysis) and [structural equation models](#sem) can relax this assumption and allow items' error terms to correlate with each other.\index{item response theory!assumptions}\index{structural equation modeling!residual!correlated}\index{factor analysis}\index{structural equation modeling}
...
A one-parameter logistic (1PL) item response theory (IRT) model is a model fit to dichotomous data, which estimates a different [difficulty](#itemDifficulty) ($b$) parameter for each item.\index{item response theory!one-parameter model}\index{item response theory!item difficulty}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLsem).\index{reliability!standard error of measurement}
...
A plot of [test information](#irtReliability) and [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLtifSEM).\index{item response theory!information}\index{item response theory!standard error of measurement}\index{reliability!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:onePLicc) and \@ref(fig:onePLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:onePLiif) and \@ref(fig:onePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#irtReliability) and [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLicc) and \@ref(fig:twoPLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLiif) and \@ref(fig:twoPLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalSEM).\index{item response theory!standard error of measurement}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on each latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLmultidimensionalICC) and \@ref(fig:twoPLmultidimensionalICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) are in Figures \@ref(fig:twoPLmultidimensionalIIF) and \@ref(fig:twoPLmultidimensionalIIFfacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtif).\index{item response theory!information}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#irtReliability) and [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:threePLicc) and \@ref(fig:threePLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:threePLiif) and \@ref(fig:threePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
The test curves suggest that the measure is most [reliable](#reliability) (i.e., provides the most [information](#irtReliability) has the smallest [standard error of measurement](#irtReliability)) at middle to lower levels of the construct.\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}

##### Test Characteristic Curve {#irt-fourPLtcc}

A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtcc).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtif).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLreliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLsem).\index{item response theory!standard error of measurement}
...
A plot of [test information](#irtReliability) and [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLtifSEM).\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:fourPLicc) and \@ref(fig:fourPLiccFacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:fourPLiif) and \@ref(fig:fourPLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelReliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelSEM).\index{item response theory!standard error of measurement}
...
Item characteristic curve ([ICC](#icc)) plots of the expected score on the item as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:gradedResponseModelICC) and \@ref(fig:gradedResponseModelICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:gradedResponseModelIIF) and \@ref(fig:gradedResponseModelIIFfacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A test characteristic curve ([TCC](#icc)) plot of the expected total score as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTCC).\index{item response theory!item characteristic curve}
...
A plot of [test information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTIF).\index{item response theory!information}\index{item response theory!test information curve}
...
A plot of test [reliability](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorReliability).\index{reliability}
...
A plot of test [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorSEM).\index{reliability!standard error of measurement}
...
A plot of [test information](#irtReliability) and [standard error of measurement](#irtReliability) (SEM) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:bifactorTIFsem).\index{item response theory!information}\index{item response theory!standard error of measurement}\index{reliability!standard error of measurement}\index{item response theory!test information curve}
...
Item characteristic curve ([ICC](#icc)) plots of the probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:bifactorICC) and \@ref(fig:bifactorICCfacet).\index{item response theory!item characteristic curve}
...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:bifactorIIF) and \@ref(fig:onePLiifFacet).\index{item response theory!information}\index{item response theory!item information curve}
...
A bifactor model can also be fit in a [CFA](#cfa) framework, sometimes called item factor analysis.\index{factor analysis!confirmatory}\index{item response theory!bifactor model}\index{factor analysis!bifactor}
...
However, there are situations where IRT models may not be preferable, such as when assessing a [formative construct](#formativeConstruct), when using [small sample sizes](#sampleSize-irt), or when [assumptions of IRT](#assumptions-irt) are violated.
