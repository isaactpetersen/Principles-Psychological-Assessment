...
::: {#fig-bayesTheorem2x2}
![](images/bayesTheorem2x2.png){width=100% fig-alt="[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio."}

[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio.
:::
...
::: {#fig-twoByTwoMatrix1}
![](images/2x2-Matrix_2a.png){width=100% fig-alt="[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio."}
...
::: {#fig-twoByTwoMatrix2}
![](images/2x2-Matrix_2b.png){width=100% fig-alt="[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives."}

[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives.
:::
...
::: {#fig-twoByTwoMatrix3}
![](images/2x2-Matrix_2c.png){width=100% fig-alt="[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums And Marginal Probabilities. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio."}

[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix With Marginal Sums And Marginal Probabilities. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives; BR = base rate; SR = selection ratio.
:::
...
::: {#fig-twoByTwoMatrix5}
![](images/2x2-Matrix_2e.png){width=100% fig-alt="[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives."}

[Confusion Matrix](#confusionMatrix): 2x2 Prediction Matrix. TP = true positives; TN = true negatives; FP = false positives; FN = false negatives.
:::
...
Thus, to account for the number of predictors in the model, we can use [adjusted $R^2$](#adjustedRsquared).\index{coefficient of determination}
...
The coefficient of predictive ability (CPA) is a generalization of [AUC](#auc) to handle non-binary outcomes including ordinal and continuous outcomes [@Gneiting2021].\index{receiver operating characteristic curve!area under the curve}\index{coefficient of predictive ability}
...
```{r calibrationContinuousOutcomeLOESS, fig.height = 8, fig.width = 8, fig.align = "center", class.source = "fold-hide", fig.cap = "(ref:calibrationContinuousOutcomeLOESSCaption)", fig.scap = "Calibration Plot for Predictions of a Continuous Outcome, With LOESS Best-Fit Line."}
...
The false discovery rate (FDR) is the [conditional probability](#conditionalProbability) of not having the condition given a positive test: $P(\text{not } C| R)$.\index{false discovery rate}\index{probability!conditional}
