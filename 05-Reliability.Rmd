...
```{r omegaHierarchical, eval = FALSE}
set.seed(52242)
ci.reliability(
  mydata[,c("item1","item2","item3","item4")],
  type = "hierarchical",
...
The data are in Table \@ref(tab:evaluatingDiagnosticIRRTable).
...
The data are in Table \@ref(tab:evaluatingRatingsIRRTable).
What is your inter-rater reliability with your colleague?
