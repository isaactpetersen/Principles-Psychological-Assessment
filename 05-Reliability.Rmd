...
An alternative formulation is that reliability ($r_{xx}$) is the lack of error variance or the degree to which observed scores are uncorrelated with error scores.\index{reliability}\index{observed score}\index{measurement error}
