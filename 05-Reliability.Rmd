...
It results in overestimates of the person's true score for some people and underestimates for other people, i.e., there is no consistent pattern across the sample.\index{measurement error!random error}\index{measurement error!between person}
