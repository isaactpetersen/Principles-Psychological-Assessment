...
A criterion of FLR < 1 evaluates whether the [average variance extracted](#averageVarianceExtracted) [AVE] of a factor is greater than the highest squared inter-correlation between the factor and other factors in the model [Fornell1981].\index{multitrait-multimethod matrix}\index{validity!construct}\index{validity!discriminant}\index{reliability!internal consistency!average variance extracted}
