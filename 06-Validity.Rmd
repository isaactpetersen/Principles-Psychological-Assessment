...
In an intervention, reactivity can be valuable because having the person self-monitor their behavior can lead to behavior improvement, as described in Section \@ref(self-monitoring).\index{observation!reactivity}\index{self-monitoring}
...
- scores on the measure show theoretically expected group differences (i.e., [criterion-related](#criterionValidity) validity with respect to some group status)\index{validity!construct}\index{validity!criterion}
- scores on the measure show theoretically expected intervention effects (i.e., [criterion-related](#criterionValidity) validity with respect to intevention)\index{validity!construct}\index{validity!criterion}
