...
We can account for the (un)reliability of each measure by specifying the residual errors.
As described in Section \@ref(exampleFactorModelsFromCorrelationMatrices) of the chapter on [factor analysis](#factor-analysis-PCA), residual errors are equal to $1 - R^2$ of the indicator.
Thus, we can account for the (un)reliability of each measure by specifying the residual errors as $1 - \text{reliability}^2$, as below:
