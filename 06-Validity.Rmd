...
In an MTMM, convergent validity evaluates whether measures targeting the same construct, but using different methods, converge upon the same construct.\index{multitrait-multimethod matrix}\index{validity!construct}\index{validity!convergent}
