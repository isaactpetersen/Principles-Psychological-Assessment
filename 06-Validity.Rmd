...
Other indexes of discriminant validity include the $\text{CI}_\text{CFA}\text{(sys)}$ [@Ronkko2020], $\chi^2\text{(sys)}$ [@Ronkko2020], and the Fornell-Larcker Ratio (FLR; i.e., whether the [average variance extracted](#averageVarianceExtracted) [AVE] of a factor is greater than the highest squared inter-correlation between the factor and other factors in the model) [Fornell1981].\index{multitrait-multimethod matrix}\index{validity!construct}\index{validity!discriminant}\index{reliability!internal consistency!average variance extracted}
