...
A path diagram of the true association is depicted in Figure \@ref(fig:disattenuationSEM).\index{measurement error!disattenuation of association}\index{measurement error!random error}\index{true association}\index{observed association}\index{reliability}\index{validity!coefficient of}\index{structural equation modeling}
