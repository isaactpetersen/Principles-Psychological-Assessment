...
My summary of validity in three words is: accuracy, utility, and meaningfulness (of the interpretations of a measure's scores for the proposed uses).
...
The interpretation of a measure's scores has *face validity* (for a given construct and a given use) if a typical person—a non-expert—who looks at the content of each item will believe that the item belongs in the scale for this construct and for this use.
