...
In the marker variable method, one of the indicators is set to have a loading of 1.
...
This measurement model with three indicators is just-identified—the number of parameters estimated is equal to the number of data points, thus leaving zero degrees of freedom.
