...
Correlation matrices of various types using the `cor.table()` function from the `petersenlab` package [@R-petersenlab] are in Tables \@ref(tab:corTable1), \@ref(tab:corTable2), and \@ref(tab:corTable3).\index{petersenlab package}\index{correlation}
