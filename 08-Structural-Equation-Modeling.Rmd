...
Here are criteria for acceptable fit and good fit of SEM models:
...
chiSquareTestP <- fitMeasures(semModelFit, fit.measures = "pvalue.scaled")
chiSquareTestBaselineP <- fitMeasures(semModelFit, fit.measures = "baseline.pvalue")
```
