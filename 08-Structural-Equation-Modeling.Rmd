...
Criteria for acceptable fit and good fit of SEM models are in \@ref(tab:semFitIndices).

Table: (\#tab:semFitIndices) Criteria for acceptable and good fit models based on fit indices in structural equation modeling.
