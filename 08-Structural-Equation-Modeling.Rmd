...
The `petersenlab` package [@R-petersenlab] includes a [`complement()` function](https://perma.cc/S26F-QSW3) that simulates data with a specified correlation in relation to an existing variable.\index{petersenlab package}
...
The examples were adapted from the `lavaan` documentation: https://perma.cc/GKY3-9YE4
...
The examples were adapted from the `lavaan` documentation: https://perma.cc/8NG9-7JAG
...
Statistical power for these more straightforward analytical approaches can be estimated in G*Power [@Faul2009]:\index{power analysis} https://perma.cc/F3RW-AXMQ
