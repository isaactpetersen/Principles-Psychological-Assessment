...
```{r measurementModelStructuralModel, out.width = "100%", fig.align = "center", fig.cap = "(ref:measurementModelStructuralModelCaption)", fig.scap = "Demarcation Between Measurement Model and Structural Model. Disturbance term is zeta.", echo = FALSE}
