...
Parsimony fit include fit indices that use information criteria fit indices, including the the Akaike Information Criterion (AIC) and the Bayesian Information Criterion (BIC).\index{structural equation modeling!fit index}\index{parsimony}
