...
The `petersenlab` package [@R-petersenlab] includes a [`complement()` function](https://stats.stackexchange.com/a/313138/20338) that simulates data with a specified correlation in relation to an existing variable.\index{petersenlab package}
