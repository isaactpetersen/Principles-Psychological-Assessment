...
Correlation matrices of various types using the `cor.table()` function from the `petersenlab` package [@R-petersenlab] are in Tables \@ref(tab:corTable1b), \@ref(tab:corTable2b), and \@ref(tab:corTable3b).\index{petersenlab package}\index{correlation}
