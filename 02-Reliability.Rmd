...
There are four non-mutually exclusive types of measurement error: within-person random error, within-person random error, between-person random error, and between-person systematic error. The four types of measurement error are depicted in Figure \@ref(fig:measurementErrorTypes).
