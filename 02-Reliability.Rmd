...
For estimating the inter-rater reliability of categorical data, use Cohen's kappa, Fleiss's kappa, the S index [**Falotico & Quatto, 2010 CITATION**], or Gwet's AC1 statistic [**Gwet, 2001 CITATION**] [@Bakeman2020]. Cohen's kappa was estimated using the `psych` package [@R-psych]. Fleiss's kappa and Gwet's AC1 statistic were estimated using the `irrCAC` package [@R-irrCAC].
