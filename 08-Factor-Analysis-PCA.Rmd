...
Modification indices are described in Section \@ref(cfaModelModIndices-sem).
Modification indices are extracted using the syntax below and are in Table \@ref(tab:modIndicesCFA).\index{structural equation modeling!modification indices}
...
A path diagram of the model is in Figure \@ref(fig:cfaPathDiagram).\index{factor analysis!confirmatory}
...
A path diagram of the model is in Figure \@ref(fig:bifactorModelPathDiagram).\index{factor analysis!bifactor}
