...
[Factor analysis](#factorAnalysis) takes a large dimension data set and simplifies it into a smaller set of factors that thought to reflect underlying constructs.\index{parsimony}\index{factor analysis!confirmatory}
...
In this model, each latent factor accounts for 60% of the variance in the indicators that load onto it: $\frac{.77^2 + .77^2 + .77^2}{3} = \frac{.60 + .60 + .60}{3} = .60$.\index{factor analysis}
Each latent factor accounts for 37% of the variance in all of the indicators: $\frac{.77^2 + .77^2 + .77^2 + (.50^2 * .77^2) + (.50^2 * .77^2) + (.50^2 * .77^2)}{6} = \frac{.60 + .60 + .60 + .15 + .15 + .15}{6} = .37$.\index{factor analysis}
...
In this model, each latent factor accounts for 60% of the variance in the indicators that load onto it: $\frac{.77^2 + .77^2 + .77^2}{3} = \frac{.60 + .60 + .60}{3} = .60$.\index{factor analysis}
Factor 1 accounts for 15% of the variance in the indicators that load onto Factor 2: $\frac{(.50^2 * .77^2) + (.50^2 * .77^2) + (.50^2 * .77^2)}{3} = \frac{.15 + .15 + .15}{3} = .15$.\index{factor analysis}
...
In this model, the higher-order factor ($A_1$) accounts for 30% of the variance in the indicators: $\frac{(.77^2 * .71^2) + (.77^2 * .71^2) + (.77^2 * .71^2) + (.77^2 * .71^2) + (.77^2 * .71^2) + (.77^2 * .71^2)}{6} = \frac{.30 + .30 + .30 + .30 + .30 + .30}{6} = .30$.\index{factor analysis}
