...
Fit indices are generated using the syntax below and are in Table \@ref(tab:efaOrthogonalFitIndices).\index{factor analysis!exploratory}\index{orthogonal rotation}
