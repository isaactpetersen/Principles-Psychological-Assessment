...
## Analogue (Structured) Assessments {#analogueAssessment}
...
Behavior rating scales are widely used in research and clinical settings. They are relatively cheap and easy to administer and score. [Item response theory](#irt) techniques reveal issues with different levels of Likert scale anchors of rating scales. For example, people assign different meanings to the levels "never," "sometimes," and "a lot." It is often better to have the rater describe or provide the numeric amount. For example: "How many times during the last week did your child physically hit someone else?"
