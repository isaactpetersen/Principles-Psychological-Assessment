...
## Overview {#overview-projective-personality}
...
There are many reasons not to use projective measures\index{personality assessment!projective}.
First, they can be very time consuming: both for the client and the psychologist, in terms of administration, scoring, and interpretation.\index{personality assessment!projective}
Second, they provide very little information.\index{personality assessment!projective}
...
Instead of relying on the client to report relatively color-less items in the [Rorschach](#rorschach), why not ask them how their mood is and observe the energy and affect?\index{personality assessment!projective}\index{self-report}\index{observation}\index{Rorschach Inkblot Test}
...
The scientific status of projective measures are described in further detail later in the chapter in Section \@ref(projectiveScientificStatus).\index{personality assessment!projective}
