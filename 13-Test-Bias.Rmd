...
```{r jobSelection3, fig.height = 8, fig.cap = "Example of a good predictor", echo = FALSE}
plot.new()
plot.window(xlim = c(-5,5), ylim = c(-5,5))
...
```{r jobSelection4, fig.height = 8, fig.cap = "Example of a bad predictor.", echo = FALSE}
plot.new()
plot.window(xlim = c(-5,5), ylim = c(-5,5))
