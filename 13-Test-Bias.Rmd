...
```{r jobSelection, out.width = "100%", fig.align = "center", fig.cap = "2x2 Confusion Matrix for Job Selection.", echo = FALSE}
...
```{r jobSelection2, fig.height = 8, fig.cap = "2x2 Confusion Matrix for Job Selection in the form of a graph with predicted performance on the x-axies and actual job performance on the y-axis.", echo = FALSE}
plot.new()
...
```{r jobSelection3, fig.height = 8, fig.cap = "Example of a strong predictor", echo = FALSE}
plot.new()
plot.window(xlim = c(-5,5), ylim = c(-5,5))
...
```{r jobSelection4, fig.height = 8, fig.cap = "Example of a poor predictor.", echo = FALSE}
plot.new()
plot.window(xlim = c(-5,5), ylim = c(-5,5))
...
```{r testBias1, out.width = "100%", fig.align = "center", fig.cap = "Test bias: different slopes.", echo = FALSE}
...
```{r testBias2, out.width = "100%", fig.align = "center", fig.cap = "Test bias: different intercepts.", echo = FALSE}
...
```{r testBias3, out.width = "100%", fig.align = "center", fig.cap = "Test bias: different intercepts and slopes.", echo = FALSE}
...
Figure \@ref(fig:testBias6).

```{r testBias6, out.width = "100%", fig.align = "center", fig.cap = "Potential unfairness in testing.", echo = FALSE}
