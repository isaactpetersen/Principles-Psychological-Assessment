...
# (PART) Part I  {#sec-part1 .unnumbered .unlisted}
...
This is similar to @Gelman2013's description of research as the garden of forking paths, where different decisions along the way can lead to different outcomes (see @fig-gardenForkingPath).\index{replication}\index{replication!failure to replicate}
