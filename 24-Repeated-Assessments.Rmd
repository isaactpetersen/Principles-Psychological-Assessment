...
```{r developmentalScaling, out.width = "100%", fig.align = "center", fig.cap = "(ref:developmentalScalingCaption)", fig.scap = "Example of the Effect of Linking the Latent Externalizing Problems Scores, $\theta$, Across Ages.", echo = FALSE}
