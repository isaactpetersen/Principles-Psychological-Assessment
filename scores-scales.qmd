...
Stanine scores are calculated using the bracketed proportions in @tbl-stanineCalculation).\index{data!standardized}\index{data!stanine score}
...
```{r}
#| label: tbl-stanineConverstionTable
