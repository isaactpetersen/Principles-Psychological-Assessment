...
Below, we describe a few errors to which clinical judgment seems particularly prone.\index{clinical judgment}

When operating freely, clinicians tend to overestimate exceptions to the established rules (i.e., the broken leg syndrome).\index{clinical judgment}\index{broken leg}
...
Because actuarial methods are based on actual population levels (i.e., [base rates](#baseRate)), unique exceptions are not overestimated.\index{clinical judgment}\index{broken leg}\index{actuarial}\index{base rate}
...
But computers can do that to an even greater degree.\index{actuarial}\index{clinical judgment}
...
People tend to overestimate the probability of low [base rate](#baseRate) conditions and events.\index{clinical judgment}\index{base rate!neglect}
