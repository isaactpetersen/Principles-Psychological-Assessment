...
The syntax used to generate an empirical ROC plot is below, and the plot is in Figure \@ref(fig:empiricalROC).\index{receiver operating characteristic curve}\index{sensitivity}\index{specificity}\index{cutoff}
