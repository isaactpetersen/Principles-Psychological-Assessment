...
```{r calibrationContinuousOutcomeLOESS, fig.height = 8, fig.width = 8, fig.align = "center", echo = FALSE, fig.cap = "(ref:calibrationContinuousOutcomeLOESSCaption)", fig.scap = "Calibration Plot for Predictions of a Continuous Outcome, With LOESS Smoother."}
...
Below, we present [PPV](#ppv) and [NPV](#npv) at every possible cutoff.\index{positive predictive value}\index{negative predictive value}\index{cutoff}
