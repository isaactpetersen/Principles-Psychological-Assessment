...
An example of a good measure for distinguishing clinical-range versus sub-clinical range is depicted in terms of [ICCs](#icc) in Figure \@ref(fig:goodMeasureICC) and in terms of [test information](#irtReliability) in Figure \@ref(fig:goodMeasureInfo). The measure is good for the intended purpose, in terms of having items that (a) span the range of interest (1–3 standard deviations above the mean of the latent construct), (b) have high [discrimination](#itemDiscrimation) and [information](#irtReliability), and (c) densely cover the range of interest without redundancy.
