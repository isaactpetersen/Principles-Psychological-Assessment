...
fitMeasures(onePLModel_cfa_fit, fit.measures = c("chisq", "df", "pvalue",
                                                 "rmsea", "cfi", "tli", "srmr"))
...
fitMeasures(twoPLModel_cfa_fit, fit.measures = c("chisq", "df", "pvalue",
                                                 "rmsea", "cfi", "tli", "srmr"))
...
for(i in 1:numberOfItems){
  for(j in 1:numberDifficultyThresholds){
    lst[[i]][,1] <- theta
    lst[[i]][,j + 1] <- twopl(a = modelCoefficients[i,1],
