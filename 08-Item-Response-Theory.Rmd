...
An example of a bad measure is depicted in Figure \@ref(fig:badMeasure), in terms of having items with low discrimination and that does not span the range of interest with dense coverage.

```{r, include = FALSE}
badMeasure <- data.frame(theta = seq(from = -4, to = 4, length.out = 1000))

badMeasure$item1 <- fourPL(b = -0.5, a = 0.4, theta = badMeasure$theta)
badMeasure$item2 <- fourPL(b = -0.4, a = 1, theta = badMeasure$theta)
badMeasure$item3 <- fourPL(b = -0.3, a = 0.8, theta = badMeasure$theta)
badMeasure$item4 <- fourPL(b = -0.2, a = 1.5, theta = badMeasure$theta)
...
```{r badMeasure, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a bad measure based on item characteristic curves of items from a bad measure estimated from two-parameter logistic model in item response theory."}
...
An example of a good measure is depicted in Figure \@ref(fig:goodMeasure), in terms of having items that span the range of interest, that have high [discrimination](#itemDiscrimation) and [information](#irtReliability), and that densely cover the range of interest without redundancy.

```{r, include = FALSE}
goodMeasure <- data.frame(theta = seq(from = -4, to = 4, length.out = 1000))

goodMeasure$item1 <- fourPL(b = 1, a = 3, theta = goodMeasure$theta)
goodMeasure$item2 <- fourPL(b = 1.10, a = 3, theta = goodMeasure$theta)
goodMeasure$item3 <- fourPL(b = 1.20, a = 3, theta = goodMeasure$theta)
goodMeasure$item4 <- fourPL(b = 1.30, a = 3, theta = goodMeasure$theta)
goodMeasure$item5 <- fourPL(b = 1.40, a = 3, theta = goodMeasure$theta)
goodMeasure$item6 <- fourPL(b = 1.50, a = 3, theta = goodMeasure$theta)
goodMeasure$item7 <- fourPL(b = 1.60, a = 3, theta = goodMeasure$theta)
goodMeasure$item8 <- fourPL(b = 1.70, a = 3, theta = goodMeasure$theta)
goodMeasure$item9 <- fourPL(b = 1.8, a = 3, theta = goodMeasure$theta)
goodMeasure$item10 <- fourPL(b = 1.9, a = 3, theta = goodMeasure$theta)
goodMeasure$item11 <- fourPL(b = 2, a = 3, theta = goodMeasure$theta)
goodMeasure$item12 <- fourPL(b = 2.1, a = 3, theta = goodMeasure$theta)
goodMeasure$item13 <- fourPL(b = 2.2, a = 3, theta = goodMeasure$theta)
goodMeasure$item14 <- fourPL(b = 2.3, a = 3, theta = goodMeasure$theta)
goodMeasure$item15 <- fourPL(b = 2.4, a = 3, theta = goodMeasure$theta)
goodMeasure$item16 <- fourPL(b = 2.5, a = 3, theta = goodMeasure$theta)
goodMeasure$item17 <- fourPL(b = 2.6, a = 3, theta = goodMeasure$theta)
goodMeasure$item18 <- fourPL(b = 2.7, a = 3, theta = goodMeasure$theta)
goodMeasure$item19 <- fourPL(b = 2.8, a = 3, theta = goodMeasure$theta)
goodMeasure$item20 <- fourPL(b = 2.9, a = 3, theta = goodMeasure$theta)
...
```{r goodMeasure, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a good measure based on item characteristic curves of items from a good measure estimated from two-parameter logistic model in item response theory."}
