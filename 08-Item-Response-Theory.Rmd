...
The formula for information in a three-parameter logistic model is:

$$
\text{information}(\theta) = a^2_i\bigg(\frac{Q_i|\theta}{P_i|\theta}\bigg)\bigg(\frac{(P_i|\theta - c_i)^2}{(1 - c_i)^2}\bigg)
(\#eq:itemInformation)
$$
