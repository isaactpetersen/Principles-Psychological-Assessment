...
Second, a good measure should have good items that yield lots of information. For example, the items should have strong [discrimination](#itemDiscrimination), that is, the items are strongly related to the construct. The items should have sufficient variability in responses. This can be achieved by having likert/multiple response items, as opposed to binary items.
