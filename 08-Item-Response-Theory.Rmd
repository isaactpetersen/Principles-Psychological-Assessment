...
badMeasureInfo$info1 <- itemInfomation(b = -2.5, a = 0.4, theta = badMeasureInfo$theta)
badMeasureInfo$info2 <- itemInfomation(b = -2.4, a = 1, theta = badMeasureInfo$theta)
badMeasureInfo$info3 <- itemInfomation(b = -2.3, a = 0.8, theta = badMeasureInfo$theta)
badMeasureInfo$info4 <- itemInfomation(b = -2.2, a = 1.5, theta = badMeasureInfo$theta)
badMeasureInfo$info5 <- itemInfomation(b = 2.0, a = 0.6, theta = badMeasureInfo$theta)
badMeasureInfo$info6 <- itemInfomation(b = 2.1, a = 1.2, theta = badMeasureInfo$theta)
badMeasureInfo$info7 <- itemInfomation(b = 2.2, a = 0.8, theta = badMeasureInfo$theta)
badMeasureInfo$info8 <- itemInfomation(b = 2.3, a = 1.3, theta = badMeasureInfo$theta)
badMeasureInfo$info9 <- itemInfomation(b = 2.4, a = 0.6, theta = badMeasureInfo$theta)
badMeasureInfo$info10 <- itemInfomation(b = 2.5, a = 0.5, theta = badMeasureInfo$theta)
...
goodMeasureInfo$info1 <- itemInfomation(b = 1.0, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info2 <- itemInfomation(b = 1.1, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info3 <- itemInfomation(b = 1.2, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info4 <- itemInfomation(b = 1.3, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info5 <- itemInfomation(b = 1.4, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info6 <- itemInfomation(b = 1.5, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info7 <- itemInfomation(b = 1.6, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info8 <- itemInfomation(b = 1.7, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info9 <- itemInfomation(b = 1.8, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info10 <- itemInfomation(b = 1.9, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info11 <- itemInfomation(b = 2.0, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info12 <- itemInfomation(b = 2.1, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info13 <- itemInfomation(b = 2.2, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info14 <- itemInfomation(b = 2.3, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info15 <- itemInfomation(b = 2.4, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info16 <- itemInfomation(b = 2.5, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info17 <- itemInfomation(b = 2.6, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info18 <- itemInfomation(b = 2.7, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info19 <- itemInfomation(b = 2.8, a = 10, theta = goodMeasureInfo$theta)
goodMeasureInfo$info20 <- itemInfomation(b = 2.9, a = 10, theta = goodMeasureInfo$theta)
