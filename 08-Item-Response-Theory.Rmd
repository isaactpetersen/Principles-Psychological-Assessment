...
```{r modelImpliedTCC, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Test characteristic curve of the expected total score on the test as a function of the person's level on the latent construct."}
...
```{r iccDiagnosticallyUseful, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Item characteristic curve of an item with a floor effect that is diagnostically useful."}
...
```{r efficientAssessment, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of an efficient assessment based on item characteristic curves from two-parameter logistic model in item response theory."}
...
```{r badMeasureICCs, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a bad measure based on item characteristic curves of items from a bad measure estimated from two-parameter logistic model in item response theory."}
...
```{r badMeasureInfo, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a bad measure based on the test information curve."}
...
```{r goodMeasureICCs, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a good measure based on item characteristic curves of items from a good measure estimated from two-parameter logistic model in item response theory."}
...
```{r goodMeasureInfo, echo = FALSE, message = FALSE, results = "hide", out.width = "100%", fig.cap = "Visual representation of a good measure based on the test information curve."}
...
Item response theory is a measurement theory and advanced modeling approach that allows estimating latent variables as the common variance from multiple items, and how the items relate to the construct (latent variable). IRT holds promise to enable the development of briefer assessments, including short forms and [adaptive assessments](#cat), that have strong [reliability](#reliability) and [validity](#validity). If you are interested in learning more about IRT, I highly recommend the book by @Embretson2000.
