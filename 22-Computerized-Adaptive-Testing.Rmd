...
For instance, below we create a matrix with the questions and response options from the [graded response model](#irt-gradedResponseModel) that we fit in Section in Chapter \@ref(irt) on [item response theory](#irt).\index{adaptive testing!computerized}\index{item response theory!graded response model}
