...
The test information and standard error as a function of the person's construct level (theta; $\theta$) is in Figure \@ref(fig:infoSE-cat). 
...
Standard errors of a person's estimated construct level (theta; $\theta$) as a function of the item (presented in the order that items were administered as part of the CAT) are in Figure \@ref(fig:standardError-cat).
