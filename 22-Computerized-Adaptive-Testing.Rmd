...
```{r infoSE-cat, out.width = "100%", fig.align = "center", fig.cap = "Test Information and Standard Error of Measurement.", echo = FALSE}
plot(
  mod,
  type = "infoSE",
  theta_lim = c(-3, 3),
...
You can examine item characteristic curves using the following syntax:\index{adaptive testing!computerized}\index{item response theory!item characteristic curve}

```{r icc-cat, eval = FALSE}
plot(mod, type = "trace", theta_lim = c(-3, 3))
```

You can examine item information curves using the following syntax:\index{adaptive testing!computerized}\index{item response theory!item information curve}

```{r info-cat, eval = FALSE}
...
Item characteristic curves and information curves for Item 30 is in Figure \@ref(fig:catICCItem30).\index{adaptive testing!computerized}\index{item response theory!item characteristic curve}\index{item response theory!item information curve}
...
```{r catICCItem30, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves and Information Curves for Item 30.", echo = FALSE}
itemplot(
  object = mod,
  item = "Item.30",
  "infotrace",
