...
Item characteristic curves and information curves for Item 30 is below.\index{adaptive testing!computerized}\index{item response theory!item characteristic curve}\index{item response theory!item information curve}

```{r, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves and Information Curves for Item 30."}
itemplot(
  object = mod,
  item = "Item.30",
  "infotrace",
