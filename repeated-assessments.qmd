...
We discussed [ambulatory assessment](#sec-ambulatory) in Section \@ref(ambulatory).
...
As described in Section \@ref(differenceScore-reliability), [difference scores](#sec-differenceScores) (also called change scores) can have limitations because they can be less [reliable](#sec-reliability) than each of the individual measures that compose the difference score.\index{difference score!reliability}
...
But there are times when we would expect a construct would, theoretically, fail to show longitudinal [factorial invariance](#sec-measurementInvariance), as in the case of heterotypic continuity, described in Section \@ref(heterotypicContinuity).\index{structural equation modeling!measurement invariance}\index{heterotypic continuity}
