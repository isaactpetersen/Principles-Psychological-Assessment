...
The [reliability](#sec-reliability) of individual differences in [change scores](#sec-differenceScores) depends on the extent to which: (a) the measures used to calculate the [change scores](#sec-differenceScores) are reliable, and (b) the variability of true individual differences in change is large—that is, there are true individual differences in change.\index{difference score!reliability}
