...
```{r reliabilityPathDiagram1, out.height = "30%", fig.align = "center", fig.cap = "Reliability of a measure across two time points, as depicted in a path diagram.", echo = FALSE}
