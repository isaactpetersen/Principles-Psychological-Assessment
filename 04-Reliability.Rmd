...
The red line is a locally estimated scatterplot smoothing (LOESS) line, which uses nonparametric estimation of the best fit.

```{r testRetestScatterplot, out.width = "100%", fig.align = "center", fig.cap = "Test–retest Reliability Scatterplot."}
