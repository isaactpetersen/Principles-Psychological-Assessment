...
Analytical examples of factor analysis are presented in Section \@ref(factorAnalysis).
...
Figure \@ref(fig:factorAnalysis1).
...
Figure \@ref(fig:factorAnalysis2).
...
Figure \@ref(fig:factorAnalysis3).
...
Figure \@ref(fig:factorAnalysis4).
...
Figure \@ref(fig:factorAnalysis5).
...
Figure \@ref(fig:factorAnalysis6).
...
Figure \@ref(fig:factorAnalysis7).
...
## Overview of Principal Component Analysis {#pcaOverview}

Analytical examples of principal component analysis are presented in Section \@ref(pca).
