...
A trifactor model is similar to (and an extension of) a [bifactor model]({#sec-bifactorModel}); however, each rating loads onto three latent sources (in this case, construct, item, and informant type).
