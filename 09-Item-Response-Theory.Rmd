...
In a 1- or 2-parameter model, the inflection point is where 50% of the sample endorses the item (or gets the item correct), that is, the point on the x-axis where the [ICC](#icc) crosses .5.\index{item response theory!item difficulty}\index{item response theory!item characteristic curve}
...
In the model, $a_i$ an item-specific [discrimination parameter](#itemDiscrimination), $b_{ic}$ is an item- and category-specific [difficulty parameter](#itemDifficulty), and $θ_n$ is an estimate of a person's standing on the latent variable, representing the child's level of externalizing problems.\index{item response theory!graded response model}\index{item response theory!two-parameter model}\index{item response theory!item difficulty}\index{item response theory!item discrimination}
...
IRT forms the basis of [adaptive testing](#cat), which is discussed in Chapter \@ref(cat).\index{item response theory}\index{brief assessment}\index{adaptive testing}
...
However, it assumes that if you get a more difficult item correct, that you would have gotten easier items correct, which might not be true in all contexts.\index{adaptive testing}
...
This can be achieved by having likert/multiple response items, as opposed to binary items.\index{item response theory}\index{data!dichotomous}\index{data!polytomous}\index{Likert scale}
...
```{r goodMeasureICCs, echo = FALSE, results = "hide", out.width = "100%", fig.align = "center", fig.align = "center", fig.cap = "Visual Representation of a Good Measure (For Distinguishing Clinical-Range Versus Sub-clinical Range) Based on Item Characteristic Curves of Items From a Good Measure Estimated From Two-Parameter Logistic Model in Item Response Theory."}
...
Based on a child's IRT-estimated ability level (i.e., level on the construct), we can have a better sense of what the child knows and does not know, because it indicates the [difficulty](#itemDifficulty) level at which they would tend to get items correct 50% of the time; the person would likely fail items with a higher [difficulty](#itemDifficulty) from this level, whereas the person would likely pass items with a lower [difficulty](#itemDifficulty) compared to this level.\index{item response theory}\index{item response theory!item difficulty}\index{item response theory!theta}
...
```{r onePLtifSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Rasch Item Response Theory Model."}
...
```{r onePLiif, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves from Rasch Item Response Theory Model."}
plot(raschModel, type = "infotrace", facet_items = FALSE)
```

```{r onePLiifFacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves from Rasch Item Response Theory Model."}
...
```{r twoPLtif, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve From Two-Parameter Logistic Item Response Theory Model."}
...
```{r twoPLtifSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Two-Parameter Logistic Item Response Theory Model."}
...
```{r twoPLiif, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Two-Parameter Logistic Item Response Theory Model."}
plot(twoPLModel, type = "infotrace", facet_items = FALSE)
```

```{r twoPLiifFacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Two-Parameter Logistic Item Response Theory Model."}
...
```{r twoPLmultidimensionalTCC, out.width = "100%", fig.align = "center", fig.cap = "Test Characteristic Curve From Two-Parameter Multidimensional Item Response Theory Model."}
...
```{r twoPLmultidimensionalTIF, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve From Two-Parameter Multidimensional Item Response Theory Model."}
...
```{r twoPLmultidimensionalSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Standard Error of Measurement From Two-Parameter Multidimensional Item Response Theory Model."}
...
```{r twoPLmultidimensionalICC, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves From Two-Parameter Multidimensional Item Response Theory Model."}
plot(twoPL2FactorModel, type = "itemscore", facet_items = FALSE)
```

```{r twoPLmultidimensionalICCfacet, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves From Two-Parameter Multidimensional Item Response Theory Model."}
...
```{r twoPLmultidimensionalIIF, out.width = "100%", fig.align = "center", fig.align = "center", fig.cap = "Item Information Curves From Two-Parameter Multidimensional Item Response Theory Model."}
plot(twoPL2FactorModel, type = "infotrace", facet_items = FALSE)
```

```{r twoPLmultidimensionalIIFfacet, out.width = "100%", fig.align = "center", fig.align = "center", fig.cap = "Item Information Curves From Two-Parameter Multidimensional Item Response Theory Model."}
...
```{r, out.width = "100%", fig.align = "center", fig.cap = "Item Factor Analysis Diagram of Two-Parameter Multidimensional Logistic Model."}
semPaths(
  twoPLModelMultidimensional_cfa_fit,
  what = "std",
  layout = "tree2",
...
```{r threePLtif, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve From Three-Parameter Logistic Item Response Theory Model."}
...
```{r threePLtifSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Three-Parameter Logistic Item Response Theory Model."}
...
```{r threePLiif, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Three-Parameter Logistic Item Response Theory Model."}
plot(threePLModel, type = "infotrace", facet_items = FALSE)
```

```{r threePLiifFacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Three-Parameter Logistic Item Response Theory Model."}
...
```{r fourPLtif, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve From Four-Parameter Logistic Item Response Theory Model."}
...
```{r fourPLtifSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Four-Parameter Logistic Item Response Theory Model."}
...
```{r fourPLiif, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Four-Parameter Logistic Item Response Theory Model."}
plot(fourPLModel, type = "infotrace", facet_items = FALSE)
```

```{r fourPLiifFacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Four-Parameter Logistic Item Response Theory Model."}
...
The test curves suggest that the measure is most [reliable](#reliability) (i.e., provides the most [information](#irtReliability) has the smallest [standard error of measurement](#irtReliability)) across a wide range of construct.\index{item response theory!information}\index{reliability}\index{item response theory!standard error of measurement}
...
```{r gradedResponseModelTIFsem, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Graded Response Model."}
...
```{r gradedResponseModelIIF, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Graded Response Model."}
plot(gradedResponseModel, type = "infotrace", facet_items = FALSE)
```

```{r gradedResponseModelIIFfacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves From Graded Response Model."}
...
```{r bifactorTCC, out.width = "100%", fig.align = "center", fig.cap = "Test Characteristic Curve From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorTIF, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorReliability, out.width = "100%", fig.align = "center", fig.cap = "Test Reliability From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorSEM, out.width = "100%", fig.align = "center", fig.cap = "Test Standard Error of Measurement From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorTIFsem, out.width = "100%", fig.align = "center", fig.cap = "Test Information Curve and Standard Error of Measurement From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorICC, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves From Bifactor Item Response Theory Model.", eval = FALSE}
plot(bifactorModel, type = "itemscore", facet_items = FALSE)
```

```{r bifactorICCfacet, out.width = "100%", fig.align = "center", fig.cap = "Item Characteristic Curves From Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorIIF, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves from Bifactor Item Response Theory Model.", eval = FALSE}
plot(bifactorModel, type = "infotrace", facet_items = FALSE)
```

```{r bifactorIIFfacet, out.width = "100%", fig.align = "center", fig.cap = "Item Information Curves from Bifactor Item Response Theory Model.", eval = FALSE}
...
```{r bifactorIFA, out.width = "100%", fig.align = "center", fig.cap = "Item Factor Analysis Diagram of One-Parameter Logistic Model."}
semPaths(
  bifactorModel_cfa_fit,
  what = "std",
  layout = "tree3",
...
```{r, echo = FALSE, out.width = "100%", fig.align = "center", fig.cap = c("Exercise 2c: Item Information Curves.")}
...
```{r, echo = FALSE, out.width = "100%", fig.align = "center", fig.cap = c("Exercise 2e: Test Information Curve.")}
