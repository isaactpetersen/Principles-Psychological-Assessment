...
2. discrimination\index{item response theory!item discrimination}
3. guessing\index{item response theory!item guessing}
4. inattention/careless errors\index{item careless errors}
...
2. have good items that yield lots of [information](#irtReliability)\index{item response theory}\index{item response theory!information}\index{reliability}
3. have a good set of items that densely cover the construct within the range of interest, without redundancy\index{item response theory}
...
```{r twoPLmultidimensionalIIF, out.width = "100%", fig.align = "center", fig.align = "center", fig.cap = "Item Information Functions From Two-Parameter Multidimensional Item Response Theory Model."}
plot(twoPL2FactorModel, type = "infotrace", facet_items = FALSE)
```

```{r twoPLmultidimensionalIIFfacet, out.width = "100%", fig.align = "center", fig.align = "center", fig.cap = "Item Information Functions From Two-Parameter Multidimensional Item Response Theory Model."}
