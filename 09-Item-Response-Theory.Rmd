...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLicc).
...
A plot of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLiif).
...
A plot of [test information](#irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLtif).

```{r twoPLtif, out.width = "100%", fig.align = "center", fig.cap = "Test Information Function From Two-Parameter Multi-Dimensional Item Response Theory Model."}
...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalICC).
...
A plot of [item information](#irtReliability) as a function of a person's level on each latent construct (theta; $\theta$) is in Figure \@ref(fig:twoPLmultidimensionalIIF).
...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLicc).
...
A plot of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:threePLiif).
...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLicc).
...
A plot of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:fourPLiif).
...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelICC).
...
A plot of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:gradedResponseModelIIF).
