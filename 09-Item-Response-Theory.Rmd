...
An item characteristic curve ([ICC](#icc)) plot of probability of item endorsement (or getting the item correct) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLicc).
...
A plot of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) is in Figure \@ref(fig:onePLiif).
