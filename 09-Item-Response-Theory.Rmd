...
Plots of [item information](#irtReliability) as a function of a person's level on the latent construct (theta; $\theta$) are in Figures \@ref(fig:fourPLiif) and \@ref(fig:fourPLiif).
