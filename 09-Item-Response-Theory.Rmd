...
Item response theory is a measurement theory and advanced modeling approach that allows estimating latent variables as the common variance from multiple items, and allows estimating how the items relate to the construct (latent variable).\index{item response theory}\index{latent variable}
