...
However, there are situations where IRT models may not be preferable, such as when assessing a [formative construct](#formativeConstruct) or when [assumptions of IRT](#assumptions-irt) are violated.
