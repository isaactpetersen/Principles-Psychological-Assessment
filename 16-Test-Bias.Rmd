...
There are multiple definitions of the term "bias" depending on the context. In general, bias is a [systematic error](#systematicError). [Mean error](#meanError) is an example of systematic error, and is sometimes called bias. [Method biases](#methodBias) are a form of systematic error that involve the influence of measurement on a person's score that is not due to the person's level on the construct. Method biases include response biases or response styles, including acquiescence and social desirability bias.
