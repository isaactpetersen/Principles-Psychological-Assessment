...
There are some known instances of test bias. Research has not produced much empirical evidence of test bias (though item-level bias is not uncommon), but that does not mean that test bias does not exist.
