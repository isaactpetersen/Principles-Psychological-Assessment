...
While test bias and accuracy are a scientific question, fairness and whether a test should be used for a given purpose are not just a scientific question; it is also an ethical question. It involves the consideration of the potential consequences of testing in terms of social values.
...
### Score Adjustment to Correct for Bias
...
### Other Ways to Correct for Bias
