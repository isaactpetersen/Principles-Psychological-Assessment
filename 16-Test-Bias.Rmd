...
5. Examine the longitudinal measurement invariance of the Antisocial scale across T1 and T2. Which type(s) of longitudinal measurement invariance failed? Which items and parameters appeared to differ across ages?
...
4.
    a. The model with item parameters constrained across sexes fit significantly worse than a model with item parameters that were allowed to vary across sexes, $\chi^2[`r apa(unconstrainedVsConstrainedDF_ex, decimals = 0)`] = `r apa(unconstrainedVsConstrainedChiSquare_ex, decimals = 2)`$. This suggests that the item parameters show differential item functioning across boys and girls.
