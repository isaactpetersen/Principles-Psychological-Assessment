...
Honor the agreement implied by the explanation provided in the informed consent. For an example of a document that I use with clients that describes the pros and cons of an intervention technique (parent management training) and other options available, see here: [**INSERT OSF LINK TO DOCUMENT**].
...
Here, I emphasize a few of the guidelines from the APA Ethics Code [**CITATION**] with respect to assessment. However, you should read and follow the entire APA Ethics Code. That said, the APA Ethics Code is not up to date for clinical science. But, there are many important components.
