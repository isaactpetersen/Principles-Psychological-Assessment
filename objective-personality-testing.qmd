...
### External Approach to Scale Construction {#sec-externalApproach}
...
In addition, artificial intelligence approaches can be leveraged for scale development and validation [e.g., @AustinInPress].\index{artificial intelligence}
...
The word satisfice is a portmanteau of satisfy and suffice—the respondent picks a "good enough" answer that will satisfy the requirements of the task and suffice for their purposes, rather than expending the effort needed to identify the optimal answer.
