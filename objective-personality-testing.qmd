...
[Projective tests](#sec-projective) are described in further detail in Chapter \@ref(projective).\index{personality assessment!projective}
...
[Factor analysis](#sec-factorAnalysisOverview) and [PCA](#sec-pca) are described in Chapter \@ref(factor-analysis-PCA).\index{factor analysis}\index{principal component analysis}
