...
For [causal](#formativeConstruct) indicators, too high of a correlation between indicators is likely to introduce the problem of multicollinearity, so lower correlations are optimal.\index{construct!formative}\index{indicator}\index{multicollinearity}
