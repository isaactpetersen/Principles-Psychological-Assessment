...
In a [formative construct](#formativeConstruct), the indicators influence the construct, and a weighted mean or sum score is justifiable.
In a [reflective construct](#reflectiveConstruct), the construct influences the indicators, and it is more appropriate to estimate it with a reflective latent variable that reflects the common variance among the indicators using [structural equation modeling](#sem), [factor analysis](#factorAnalysis), or [item response theory](#irt).
