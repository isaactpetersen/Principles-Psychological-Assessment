...
Endogenous variables are variables whose vales are determined by the model (i.e., they are influenced by other variables), whereas exogenous variables are variables whose values are not determined by the model (i.e., they are not influenced by other variables).\index{structural equation modeling}
