...
The Kaiser-Meyer-Oklin (KMO) test of sampling adequacy [@Kaiser1970; @Kaiser1974a] evaluates the extent to which a set of variables is suitable for factor analysis.
