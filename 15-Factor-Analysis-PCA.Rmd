...
The cross loadings for the anchor item are fixed to the respective loadings from the original [EFA](#efa) model.
...
make_esem_model <- function(loadings, anchors){
  ...
  # Make syntax column per item (which differs depending on whether the an item loading is an anchor loading)
  loadings$syntax <- NA
