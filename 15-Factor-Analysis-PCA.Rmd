...
Before conducting a [factor analysis](#factorAnalysis), it is important examine descriptive statistics and correlations among variables.\index{correlation}
...
Here are correlation matrices of various types using the `cor.table()` from the `petersenlab` package [@R-petersenlab]:\index{petersenlab}\index{correlation}
...
The examples were adapted from the `lavaan` documentation: http://lavaan.ugent.be/tutorial/cfa.html\index{factor analysis!confirmatory}
