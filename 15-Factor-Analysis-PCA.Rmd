...
Bartlett's test evaluates whether the correlations between the variables are significantly different from zero.
...
residuals(efaOrthogonalLavaan_fit$nf3)
...
residuals(efaObliqueLavaan_fit$nf3)
