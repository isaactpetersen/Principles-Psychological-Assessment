...
A pairs panel plot is in Figure \@ref(pairsPlotOrthogonalPCA).
...
A correlation plot is in Figure \@ref(correlationPlotOrthogonalPCA).
...
A pairs panel plot is in Figure \@ref(pairsPlotObliquePCA).
...
A correlation plot is in Figure \@ref(correlationPlotObliquePCA).
...
1.
    a. A scree plot is in Figure \@ref(screePlot_ex).
...
Some alternative, equivalently fitting models are in Figure \@ref(equivalentModels_ex).
