...
Alternatively, there could be a single factor that influences measures 1, 2, 3, 4, 5, and 6 with a [method bias](#methodBias) factor (e.g., a particular measurement method, item stem, reverse-worded item, or another [method bias](#methodBias)) that influences measures 4, 5, and 6, as depicted in Figure \@ref(fig:factorAnalysis10).\index{factor analysis}\index{method bias}
...
cfaModel4E <- '
 ...
 #Constrain factor variances to one
 f1 ~~ 1*f1
 f2 ~~ 1*f2
'
```
