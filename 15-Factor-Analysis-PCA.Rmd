...
[Factor analysis](#factorAnalysis) takes a large dimension data set and simplifies into smaller constructs.
...
If a [CFA](#cfa) model without cross loadings and correlated residuals fits as well as an ESEM model with all cross loadings, the [CFA](#cfa) model should be retained for its simplicity.\index{cross loading}\index{residuals!correlated}
