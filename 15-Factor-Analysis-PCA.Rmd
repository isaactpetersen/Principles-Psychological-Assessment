...
The function below for creating `lavaan` syntax for an ESEM model is adapted from Mateus Silvestrin: https://msilvestrin.me/post/esem/
...
```{r esemModelPathDiagram, out.width = "100%", fig.align = "center", fig.cap = "Bifactor Model."}
