...
Several of the packages are hosted on GitHub repositories, including `uroc` [@Gneiting2021], `blandr`, and `dmacs` [@R-dmacs].\index{GitHub}

You can install the `uroc`, `blandr` and `dmacs` packages using the following code:
