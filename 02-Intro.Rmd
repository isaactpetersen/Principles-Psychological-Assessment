...
## About This Book {.unnumbered #about}
...
The chapters provide an overview of topics that each could have its own class and textbook, such as [structural equation modeling](#sem), [item response theory](#irt), [generalizability theory](#gTheory), [factor analysis](#factor-analysis-PCA), [prediction](#prediction), [cognitive assessment](#cognition), [psychophysiological assessment](#psychophysiological), etc.
...
In addition to discussing principles, however, analysis scripts in the software `R` [@R-base] are also provided, so that you are able to apply the principles discussed in this book.\index{R}
Analysis exercises for each chapter are freely available in the online version of the book: https://isaactpetersen.github.io/Principles-Psychological-Assessment/

## Why R? {.unnumbered #whyR}
...
## About the Author {.unnumbered #aboutTheAuthor}
...
## What Is Assessment? {.unnumbered #whatIsAssessment}
...
## Why Should We Care About Assessment (and Science)? {.unnumbered #whyCare}
...
The problem is that there has been a proliferation of pseudo-science in assessment and treatment.\index{pseudo-science}
There are widely used psychological assessments and treatments that we know are inaccurate, do not work, or in some cases, that we know to be harmful.\index{pseudo-science}
Lists of harmful psychological treatments [e.g., @Lilienfeld2007] and inaccurate assessments [e.g., @Hunsley2015] have been published, but these treatments and assessments are still used by professional providers to this day.\index{pseudo-science}
...
> 
> Third Corollary: A scientific epistemology differentiates science from pseudo-science.\index{clinical science}\index{pseudo-science}
> 
...
### Assessment and the Replication Crisis in Science {.unnumbered #assessmentReplicationCrisis}
...
```{r gardenForkingPaths, out.width = "100%", fig.align = "center", fig.cap = "Garden of Forking Paths. Adapted from https://www.si.umich.edu/about-umsi/news/ditch-stale-pdf-making-research-papers-interactive-and-more-transparent (archived at https://perma.cc/R2V9-CP3F).", echo = FALSE}
...
### Science Versus Pseudo-Science in Assessment {.unnumbered #scienceVsPseudoscience}
...
Here are characteristics of science that distinguish it from pseudo-science:\index{science}\index{pseudo-science}
...
## Prerequisites {.unnumbered #prerequisites}
