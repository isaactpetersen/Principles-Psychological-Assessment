...
The chapters provide an overview of topics that each could have their own class and textbook, such as [structural equation modeling](#sem), [item response theory](#irt), [generalizability theory](#gTheory), [factor analysis](#factor-analysis-PCA), [prediction](#prediction), [cognitive assessment](#cognition), [psychophysiological assessment](#psychophysiological), etc.
...
### Science Versus Pseudoscience in Assessment {.unnumbered #scienceVsPseudoscience}
