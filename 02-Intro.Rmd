...
Several of the packages are hosted on GitHub/GitLab repositories, including `uroc` [@Gneiting2021], `dmacs` [@R-dmacs], and `petersenlab` [@R-petersenlab].
...
Many of the `R` functions used in this book are available from the `petersenlab` package [@R-petersenlab]\index{petersenlab}: https://research-git.uiowa.edu/PetersenLab/petersenlab.
