...
6. Scientifically supported measurement strategies are used based on their psychometrics, including reliability and validity.\index{science}
...
Several of the packages are hosted on GitHub/GitLab repositories, including `uroc` [@Gneiting2021], `dmacs` [@R-dmacs], and `petersenlab` [@R-petersenlab].\index{GitHub}
