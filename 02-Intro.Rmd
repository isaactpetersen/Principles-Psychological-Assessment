...
Some of the chapters includes analysis exercises (at the end of the chapter) for you to test your comprehension.
...
Several of the packages are hosted on GitHub repositories, including `uroc` [@Gneiting2021], `dmacs` [@R-dmacs], and [`petersenlab`](https://github.com/DevPsyLab/petersenlab) [@R-petersenlab].\index{GitHub}\index{petersenlab package}
...
You can install the [`petersenlab`](https://github.com/DevPsyLab/petersenlab) package [@R-petersenlab] using the following code:\index{petersenlab package}
