...
## Our Ethical Advice {#myEthicalAdvice}

Our ethical advice is summarized in the following:\index{ethics}
...
For an example of a document that we use with clients that describes the pros and cons of an intervention technique (parent management training) and other options available, see here:\index{informed consent} https://osf.io/qmnu6.
...
Here, we emphasize a few of the guidelines from the APA Ethics Code with respect to assessment.\index{ethics!APA Ethics Code}
...
We would argue that assessments should be selected based on the best available scientific evidence.\index{ethics!APA Ethics Code}
