...
Assessments yield information. The information is encoded in scores or in other [types of data](#dataTypes). It is important to consider the different [types of data](#dataTypes) because the [types of data](#dataTypes) restrict what options are available to analyze the data.
