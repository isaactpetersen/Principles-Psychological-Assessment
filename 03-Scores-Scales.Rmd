...
A standard normal distribution on various norm-referenced scales is depicted in Figure \@ref(fig:normedDistribution).
...
standardNormal$Tscore <- c(0,20,30,40,50,60,70,80,100)
standardNormal$standardScore <- c(15,55,70,85,100,115,130,145,160)
...
par(xpd = NA,
    ...
    mar = c(12, 7, 4, 2) + 0.1) # plot margins: default of the form c(bottom, left, top, right): c(5, 4, 4, 2) + 0.1
...
axis(side = 1, at = standardNormal$zScore, pos = -.05, labels = standardNormal$Tscore)
axis(side = 1, at = standardNormal$zScore, pos = -.10, labels = standardNormal$standardScore)
axis(side = 1, at = standardNormal$zScore, pos = -.15, labels = standardNormal$cumulativePercentFigure)
axis(side = 1, at = standardNormalPercentiles$percentileRankZ, pos = -.20, labels = standardNormalPercentiles$percentileRank)
rect(xleft = standardNormalStanines$stanineCumulativeStartingPercentZ, ybottom = -.30, xright = standardNormalStanines$stanineCumulativeEndingPercentZ, ytop = -.25)
...
text(-3.5, -.083, labels = "...", cex = 2)
text(3.5, -.083, labels = "...", cex = 2)
text(-3.5, -.133, labels = "...", cex = 2)
text(3.5, -.133, labels = "...", cex = 2)
mtext("Percent of cases \n under segment of \n the normal curve", side = 2, line = 0, at = .05, las = 1)
mtext("z-scores", side = 2, line = 0, at = -.025, las = 1)
mtext("T-scores", side = 2, line = 0, at = -.075, las = 1)
mtext("Standard scores", side = 2, line = 0, at = -.125, las = 1)
mtext("Cumulative percent", side = 2, line = 0, at = -.175, las = 1)
mtext("Percentile ranks", side = 2, line = 0, at = -.225, las = 1)
mtext("Stanines", side = 2, line = 0, at = -.275, las = 1)
```
...
```{r scaleScores, fig.align = "center", out.width = "100%", fig.cap = "Histogram of Scale Scores"}
hist(scores$scaleScore, xlab = "Scale Scores", main = "Histogram of Scale Scores")
```

##### Stanine scores

Stanine scores (short for STANdard Nine), have a mean of 5 and a standard deviation of 2. The scores range from 1–9.
