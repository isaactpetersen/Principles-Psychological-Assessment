...
The area under a normal curve within one standard deviation of the mean is depicted in Figure \@ref(fig:zScoreDensity1SD) and is calculated below using the `pnorm()` function, which calculates the cumulative density function for a normal curve.\index{data!standardized}
...
```{r zScoreDensity1SD, out.width = "100%", fig.align = "center", echo = FALSE, fig.cap = "Density of Standard Normal Distribution. The gray region represents the area within one standard deviation of the mean.", fig.scap = "Density of Standard Normal Distribution: One Standard Deviation of the Mean."}
...
The area under a normal curve within two standard deviations of the mean is depicted in Figure \@ref(fig:zScoreDensity2SD) and is calculated below:\index{data!standardized}
...
```{r zScoreDensity2SD, out.width = "100%", fig.align = "center", echo = FALSE, fig.cap = "Density of Standard Normal Distribution. The gray region represents the area within two standard deviations of the mean.", fig.scap = "Density of Standard Normal Distribution: Two Standard Deviations of the Mean."}
x <- seq(-4, 4, length = 200)
y <- dnorm(x, mean = 0, sd = 1)
plot(x, y, type = "l",
     xlab = "z Score",
...
The area under a normal curve within three standard deviations of the mean is depicted in Figure \@ref(fig:zScoreDensity3SD) and is calculated below:\index{data!standardized}
...
```{r zScoreDensity3SD, out.width = "100%", fig.align = "center", echo = FALSE, fig.cap = "Density of Standard Normal Distribution. The gray region represents the area within three standard deviations of the mean.", fig.scap = "Density of Standard Normal Distribution: Three Standard Deviations of the Mean."}
x <- seq(-4, 4, length = 200)
y <- dnorm(x, mean = 0, sd = 1)
plot(x, y, type = "l",
     xlab = "z Score",
