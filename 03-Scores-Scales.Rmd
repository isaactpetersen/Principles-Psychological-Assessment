...
For the Minnesota Multiphasic Personality Inventory (MMPI), you would examine peaks (elevations $\ge$ 70) and absences ($\le$ 30).\index{data!\textit{T} score}\index{MMPI}
