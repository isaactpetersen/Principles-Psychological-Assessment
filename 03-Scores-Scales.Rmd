...
```{r zScoreDensity1SD, out.width = "100%", fig.align = "center", class.source = "fold-hide", fig.cap = "Density of Standard Normal Distribution. The blue region represents the area within one standard deviation of the mean."}
