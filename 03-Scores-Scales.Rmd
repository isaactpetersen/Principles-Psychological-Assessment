...
```{r zScoreDensity2SD, out.width = "100%", fig.align = "center", class.source = "fold-hide", fig.cap = "Density of Standard Normal Distribution. The blue region represents the area within two standard deviations of the mean."}
x <- seq(-4, 4, length = 200)
y <- dnorm(x, mean = 0, sd = 1)
plot(x, y, type = "l",
     xlab = "z Score",
...
```{r zScoreDensity3SD, out.width = "100%", fig.align = "center", class.source = "fold-hide", fig.cap = "Density of Standard Normal Distribution. The blue region represents the area within three standard deviations of the mean."}
x <- seq(-4, 4, length = 200)
y <- dnorm(x, mean = 0, sd = 1)
plot(x, y, type = "l",
     xlab = "z Score",
...
```{r stanineScores, out.width = "100%", fig.align = "center", class.source = "fold-hide", fig.cap = "Histogram of Scaled Scores."}
