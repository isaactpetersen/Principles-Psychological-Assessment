...
Percentile ranks reflect what percent of people the person scored higher than.
...
Area under normal curve within one standard deviation of the mean:

```{r}
pnorm(1) - pnorm(-1)
```

Area under normal curve within two standard deviations of the mean:

```{r}
pnorm(2) - pnorm(-2)
```

Area under normal curve within three standard deviations of the mean:
