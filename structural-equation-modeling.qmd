...
$$
text{Cov}(x,y) = \text{unstandardized path coefficient of } x \text{ on } y \times \text{Var}(x)
...
The model-implied correlation between $x$ and $y$ is equal to the standardized path coefficient of $x$ on $y$, as in @eq-correlationBivariateRegression:
...
\begin{aligned}
  \text{Var}(y) &= \text{unstandardized path coefficient of } x \text{ on } y \times \text{Var}(x) \times \text{unstandardized path coefficient of } x \text{ on } y + \text{disturbance}  \\
                &= \text{squared unstandardized path coefficient of } x \text{ on } y \times \text{Var}(x) + \text{disturbance}
\end{aligned}
...
The model-implied variance of the disturbance of $y$ ($\varepsilon$) is in @eq-disturbanceBivariateRegression:

$$
\begin{aligned}
  \text{Var}(\varepsilon) &= \text{Var}(y) - \frac{\text{Cov}(x,y)^2}{\text{Var}(x)} \\
                          &= 1 - \text{squared standardized path coefficient of } x \text{ on } y \\
\end{aligned}
$$ {#eq-disturbanceBivariateRegression}
