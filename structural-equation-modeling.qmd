...
A SEM model includes both the [measurement model](#sec-measurementModel-sem) and the [structural model](#sec-structuralModel-sem) [see Figure \@ref(fig:measurementModelStructuralModel), @Civelek2018].\index{structural equation modeling}\index{structural equation modeling!measurement model}\index{structural equation modeling!structural model}
...
A path diagram of the model is in Figure \@ref(fig:measurementModel).
