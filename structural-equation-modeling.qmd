...
Sixth, as described in the next section (\@ref(semMethodBias)), SEM can be used to account for different forms of [measurement error](#sec-measurementError) (e.g., [method bias](#sec-methodBias)).\index{structural equation modeling}\index{measurement error}\index{method bias}
...
## Guidelines for Reporting Reliability and Validity in SEM {#semReliabilityValidityReporting}
