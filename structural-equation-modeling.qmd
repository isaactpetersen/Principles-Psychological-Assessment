...
In Section \@ref(cfaExample-sem), I present an example of a [CFA](#sec-cfa) model.\index{factor analysis!confirmatory}
...
In Section \@ref(cfaExample-sem), I present a [CFA model](#sec-cfa) with multiple latent factors.\index{factor analysis!confirmatory}
...
Cross-loadings can complicate the interpretation of latent factors, as discussed in Section \@ref(factorRotation) of the chapter on [factor analysis](#sec-factor-analysis-PCA).\index{cross-loading}
...
I provide an example showing that SEM disattenuates associations for [measurement error](#sec-measurementError) in Section \@ref(disattenuation).\index{structural equation modeling}\index{measurement error}\index{method bias}\index{association!disattenuation of}\index{measurement error!disattenuation of association}
...
I provide an example of fitting a [multitrait-multimethod matrix](#sec-MTMM) in [CFA](#sec-cfa) in Sections \@ref(mtmmCFA-validity) and \@ref(mtmmCFA).\index{factor analysis!confirmatory}\index{multitrait-multimethod matrix}
