...
I discuss [CFA](#sec-cfa) models in greater depth in Chapter \@ref(factor-analysis-PCA).\index{factor analysis!confirmatory}
...
Path analytic diagrams (i.e., causal diagrams with boxes, circles, and lines) are described in @sec-cttOverview) of Chapter \@ref(reliability).
